...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/settings_ext/print/PrintSettingsFragment$PrintJobsLoader;,
        Lcom/android/settings_ext/print/PrintSettingsFragment$PrintJobsController;,
        Lcom/android/settings_ext/print/PrintSettingsFragment$SettingsContentObserver;,
        Lcom/android/settings_ext/print/PrintSettingsFragment$SettingsPackageMonitor;
    }
.end annotation
...
.field private mPrintJobsController:Lcom/android/settings_ext/print/PrintSettingsFragment$PrintJobsController;
...
.field private final mSettingsContentObserver:Lcom/android/settings_ext/print/PrintSettingsFragment$SettingsContentObserver;
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 560
    new-instance v0, Lcom/android/settings_ext/print/PrintSettingsFragment$3;

    invoke-direct {v0}, Lcom/android/settings_ext/print/PrintSettingsFragment$3;-><init>()V

    sput-object v0, Lcom/android/settings_ext/print/PrintSettingsFragment;->SEARCH_INDEX_DATA_PROVIDER:Lcom/android/settings_ext/search/Indexable$SearchIndexProvider;
...
.method public constructor <init>()V
    ...
    .line 105
    new-instance v0, Lcom/android/settings_ext/print/PrintSettingsFragment$SettingsPackageMonitor;

    const/4 v1, 0x0

    invoke-direct {v0, p0, v1}, Lcom/android/settings_ext/print/PrintSettingsFragment$SettingsPackageMonitor;-><init>(Lcom/android/settings_ext/print/PrintSettingsFragment;Lcom/android/settings_ext/print/PrintSettingsFragment$1;)V

    iput-object v0, p0, Lcom/android/settings_ext/print/PrintSettingsFragment;->mSettingsPackageMonitor:Lcom/android/internal/content/PackageMonitor;

    .line 107
    new-instance v0, Lcom/android/settings_ext/print/PrintSettingsFragment$1;

    invoke-direct {v0, p0}, Lcom/android/settings_ext/print/PrintSettingsFragment$1;-><init>(Lcom/android/settings_ext/print/PrintSettingsFragment;)V

    iput-object v0, p0, Lcom/android/settings_ext/print/PrintSettingsFragment;->mHandler:Landroid/os/Handler;

    .line 114
    new-instance v0, Lcom/android/settings_ext/print/PrintSettingsFragment$2;

    iget-object v1, p0, Lcom/android/settings_ext/print/PrintSettingsFragment;->mHandler:Landroid/os/Handler;

    invoke-direct {v0, p0, v1}, Lcom/android/settings_ext/print/PrintSettingsFragment$2;-><init>(Lcom/android/settings_ext/print/PrintSettingsFragment;Landroid/os/Handler;)V

    iput-object v0, p0, Lcom/android/settings_ext/print/PrintSettingsFragment;->mSettingsContentObserver:Lcom/android/settings_ext/print/PrintSettingsFragment$SettingsContentObserver;

    .line 452
    return-void
.end method

.method static synthetic access$100(Lcom/android/settings_ext/print/PrintSettingsFragment;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/settings_ext/print/PrintSettingsFragment;

    .prologue
    .line 80
    invoke-direct {p0}, Lcom/android/settings_ext/print/PrintSettingsFragment;->updateServicesPreferences()V

    return-void
.end method

.method static synthetic access$300(Lcom/android/settings_ext/print/PrintSettingsFragment;)Landroid/os/Handler;
    .locals 1
    .param p0, "x0"    # Lcom/android/settings_ext/print/PrintSettingsFragment;
...
.method static synthetic access$400(Lcom/android/settings_ext/print/PrintSettingsFragment;)Landroid/preference/PreferenceCategory;
    .locals 1
    .param p0, "x0"    # Lcom/android/settings_ext/print/PrintSettingsFragment;

    .prologue
    .line 80
    iget-object v0, p0, Lcom/android/settings_ext/print/PrintSettingsFragment;->mActivePrintJobsCategory:Landroid/preference/PreferenceCategory;
...
.method private updateServicesPreferences()V
    ...
    .prologue
    .line 197
    invoke-virtual/range {p0 .. p0}, Lcom/android/settings_ext/print/PrintSettingsFragment;->getPreferenceScreen()Landroid/preference/PreferenceScreen;
    ...
    iget-object v0, v0, Lcom/android/settings_ext/print/PrintSettingsFragment;->mPrintServicesCategory:Landroid/preference/PreferenceCategory;
    ...
    .line 205
    :goto_0
    invoke-virtual/range {p0 .. p0}, Lcom/android/settings_ext/print/PrintSettingsFragment;->getActivity()Landroid/app/Activity;

    move-result-object v17

    invoke-static/range {v17 .. v17}, Lcom/android/settings_ext/print/PrintSettingsUtils;->readEnabledPrintServices(Landroid/content/Context;)Ljava/util/List;
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/android/settings_ext/print/PrintSettingsFragment;->getPreferenceManager()Landroid/preference/PreferenceManager;
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/android/settings_ext/print/PrintSettingsFragment;->getPackageManager()Landroid/content/pm/PackageManager;
    ...
    .line 229
    const-class v17, Lcom/android/settings_ext/print/PrintServiceSettingsFragment;
    ...
    .line 234
    const v17, 0x7f09062a

    move-object/from16 v0, p0

    move/from16 v1, v17

    invoke-virtual {v0, v1}, Lcom/android/settings_ext/print/PrintSettingsFragment;->getString(I)Ljava/lang/String;
    ...
    invoke-virtual {v0, v1, v2}, Lcom/android/settings_ext/print/PrintSettingsFragment;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings_ext/print/PrintSettingsFragment;->mActivePrintJobsCategory:Landroid/preference/PreferenceCategory;
    ...
    iput-object v0, p0, Lcom/android/settings_ext/print/PrintSettingsFragment;->mPrintServicesCategory:Landroid/preference/PreferenceCategory;
    ...
    iget-object v1, p0, Lcom/android/settings_ext/print/PrintSettingsFragment;->mActivePrintJobsCategory:Landroid/preference/PreferenceCategory;

    invoke-virtual {v0, v1}, Landroid/preference/PreferenceScreen;->removePreference(Landroid/preference/Preference;)Z

    .line 140
    new-instance v0, Lcom/android/settings_ext/print/PrintSettingsFragment$PrintJobsController;

    invoke-direct {v0, p0, v3}, Lcom/android/settings_ext/print/PrintSettingsFragment$PrintJobsController;-><init>(Lcom/android/settings_ext/print/PrintSettingsFragment;Lcom/android/settings_ext/print/PrintSettingsFragment$1;)V

    iput-object v0, p0, Lcom/android/settings_ext/print/PrintSettingsFragment;->mPrintJobsController:Lcom/android/settings_ext/print/PrintSettingsFragment$PrintJobsController;
    ...
    iget-object v2, p0, Lcom/android/settings_ext/print/PrintSettingsFragment;->mPrintJobsController:Lcom/android/settings_ext/print/PrintSettingsFragment$PrintJobsController;
...
.method public onItemSelected(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    iget-object v2, p0, Lcom/android/settings_ext/print/PrintSettingsFragment;->mProfileSpinnerAdapter:Lcom/android/settings_ext/UserSpinnerAdapter;
    ...
    .line 305
    iget-object v2, p0, Lcom/android/settings_ext/print/PrintSettingsFragment;->mSpinner:Landroid/widget/Spinner;
...
.method public onPause()V
    ...
    .prologue
    .line 157
    iget-object v0, p0, Lcom/android/settings_ext/print/PrintSettingsFragment;->mSettingsPackageMonitor:Lcom/android/internal/content/PackageMonitor;

    invoke-virtual {v0}, Lcom/android/internal/content/PackageMonitor;->unregister()V

    .line 158
    iget-object v0, p0, Lcom/android/settings_ext/print/PrintSettingsFragment;->mSettingsContentObserver:Lcom/android/settings_ext/print/PrintSettingsFragment$SettingsContentObserver;

    invoke-virtual {p0}, Lcom/android/settings_ext/print/PrintSettingsFragment;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/android/settings_ext/print/PrintSettingsFragment$SettingsContentObserver;->unregister(Landroid/content/ContentResolver;)V
...
.method public onResume()V
    ...
    invoke-virtual {v0, v1}, Lcom/android/settings_ext/print/PrintSettingsFragment$SettingsContentObserver;->register(Landroid/content/ContentResolver;)V
    ...
    .line 152
    invoke-direct {p0}, Lcom/android/settings_ext/print/PrintSettingsFragment;->startSubSettingsIfNeeded()V
...
.method public onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v4}, Lcom/android/settings_ext/print/PrintSettingsFragment;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-static {v3, v4}, Lcom/android/settings_ext/Utils;->createUserSpinnerAdapter(Landroid/os/UserManager;Landroid/content/Context;)Lcom/android/settings_ext/UserSpinnerAdapter;

    move-result-object v4

    iput-object v4, p0, Lcom/android/settings_ext/print/PrintSettingsFragment;->mProfileSpinnerAdapter:Lcom/android/settings_ext/UserSpinnerAdapter;

    .line 187
    iget-object v4, p0, Lcom/android/settings_ext/print/PrintSettingsFragment;->mProfileSpinnerAdapter:Lcom/android/settings_ext/UserSpinnerAdapter;
    ...
    iput-object v4, p0, Lcom/android/settings_ext/print/PrintSettingsFragment;->mSpinner:Landroid/widget/Spinner;

    .line 190
    iget-object v4, p0, Lcom/android/settings_ext/print/PrintSettingsFragment;->mSpinner:Landroid/widget/Spinner;

    iget-object v5, p0, Lcom/android/settings_ext/print/PrintSettingsFragment;->mProfileSpinnerAdapter:Lcom/android/settings_ext/UserSpinnerAdapter;
    ...
    invoke-virtual {p0, v4}, Lcom/android/settings_ext/print/PrintSettingsFragment;->setPinnedHeaderView(Landroid/view/View;)V
