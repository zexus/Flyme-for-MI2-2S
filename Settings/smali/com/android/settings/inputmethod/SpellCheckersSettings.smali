...
.method static synthetic access$000(Lcom/android/settings_ext/inputmethod/SpellCheckersSettings;)Landroid/view/textservice/TextServicesManager;
    .locals 1
    .param p0, "x0"    # Lcom/android/settings_ext/inputmethod/SpellCheckersSettings;

    .prologue
    .line 40
    iget-object v0, p0, Lcom/android/settings_ext/inputmethod/SpellCheckersSettings;->mTsm:Landroid/view/textservice/TextServicesManager;
...
.method static synthetic access$100(I)I
    ...
    .prologue
    .line 40
    invoke-static {p0}, Lcom/android/settings_ext/inputmethod/SpellCheckersSettings;->convertDialogItemIdToSubtypeIndex(I)I
...
.method static synthetic access$200(Lcom/android/settings_ext/inputmethod/SpellCheckersSettings;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/settings_ext/inputmethod/SpellCheckersSettings;

    .prologue
    .line 40
    invoke-direct {p0}, Lcom/android/settings_ext/inputmethod/SpellCheckersSettings;->updatePreferenceScreen()V

    return-void
.end method

.method static synthetic access$300(Lcom/android/settings_ext/inputmethod/SpellCheckersSettings;Landroid/view/textservice/SpellCheckerInfo;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/settings_ext/inputmethod/SpellCheckersSettings;
    ...
    .prologue
    .line 40
    invoke-direct {p0, p1}, Lcom/android/settings_ext/inputmethod/SpellCheckersSettings;->changeCurrentSpellChecker(Landroid/view/textservice/SpellCheckerInfo;)V
...
.method private populatePreferenceScreen()V
    ...
    iget-object v6, p0, Lcom/android/settings_ext/inputmethod/SpellCheckersSettings;->mEnabledScis:[Landroid/view/textservice/SpellCheckerInfo;
    ...
    new-instance v3, Lcom/android/settings_ext/inputmethod/SpellCheckerPreference;

    invoke-direct {v3, v0, v4, p0}, Lcom/android/settings_ext/inputmethod/SpellCheckerPreference;-><init>(Landroid/content/Context;Landroid/view/textservice/SpellCheckerInfo;Lcom/android/settings_ext/inputmethod/SpellCheckerPreference$OnRadioButtonPreferenceListener;)V

    .line 77
    .local v3, "pref":Lcom/android/settings_ext/inputmethod/SpellCheckerPreference;
    ...
    .end local v3    # "pref":Lcom/android/settings_ext/inputmethod/SpellCheckerPreference;
...
.method private showChooseLanguageDialog()V
    ...
    .line 162
    iget-object v9, p0, Lcom/android/settings_ext/inputmethod/SpellCheckersSettings;->mDialog:Landroid/app/AlertDialog;
    ...
    .line 165
    :cond_0
    iget-object v9, p0, Lcom/android/settings_ext/inputmethod/SpellCheckersSettings;->mTsm:Landroid/view/textservice/TextServicesManager;
    ...
    invoke-direct {p0, v2, v9}, Lcom/android/settings_ext/inputmethod/SpellCheckersSettings;->getSpellCheckerSubtypeLabel(Landroid/view/textservice/SpellCheckerInfo;Landroid/view/textservice/SpellCheckerSubtype;)Ljava/lang/CharSequence;
    ...
    invoke-static {v4}, Lcom/android/settings_ext/inputmethod/SpellCheckersSettings;->convertSubtypeIndexToDialogItemId(I)I

    move-result v5

    .line 177
    .local v5, "itemId":I
    invoke-direct {p0, v2, v7}, Lcom/android/settings_ext/inputmethod/SpellCheckersSettings;->getSpellCheckerSubtypeLabel(Landroid/view/textservice/SpellCheckerInfo;Landroid/view/textservice/SpellCheckerSubtype;)Ljava/lang/CharSequence;
    ...
    :cond_2
    new-instance v9, Lcom/android/settings_ext/inputmethod/SpellCheckersSettings$1;

    invoke-direct {v9, p0, v2}, Lcom/android/settings_ext/inputmethod/SpellCheckersSettings$1;-><init>(Lcom/android/settings_ext/inputmethod/SpellCheckersSettings;Landroid/view/textservice/SpellCheckerInfo;)V
    ...
    iput-object v9, p0, Lcom/android/settings_ext/inputmethod/SpellCheckersSettings;->mDialog:Landroid/app/AlertDialog;
...
.method private showSecurityWarnDialog(Lcom/android/settings_ext/inputmethod/SpellCheckerPreference;)V
    .locals 7
    .param p1, "pref"    # Lcom/android/settings_ext/inputmethod/SpellCheckerPreference;

    .prologue
    const/4 v6, 0x1

    .line 206
    iget-object v2, p0, Lcom/android/settings_ext/inputmethod/SpellCheckersSettings;->mDialog:Landroid/app/AlertDialog;
    ...
    .line 209
    :cond_0
    invoke-virtual {p1}, Lcom/android/settings_ext/inputmethod/SpellCheckerPreference;->getSpellCheckerInfo()Landroid/view/textservice/SpellCheckerInfo;
    ...
    invoke-direct {v3, p0, v1}, Lcom/android/settings_ext/inputmethod/SpellCheckersSettings$2;-><init>(Lcom/android/settings_ext/inputmethod/SpellCheckersSettings;Landroid/view/textservice/SpellCheckerInfo;)V
    ...
    new-instance v3, Lcom/android/settings_ext/inputmethod/SpellCheckersSettings$3;

    invoke-direct {v3, p0}, Lcom/android/settings_ext/inputmethod/SpellCheckersSettings$3;-><init>(Lcom/android/settings_ext/inputmethod/SpellCheckersSettings;)V
    ...
    iput-object v2, p0, Lcom/android/settings_ext/inputmethod/SpellCheckersSettings;->mDialog:Landroid/app/AlertDialog;
...
.method private updatePreferenceScreen()V
    ...
    .line 104
    iget-object v8, p0, Lcom/android/settings_ext/inputmethod/SpellCheckersSettings;->mTsm:Landroid/view/textservice/TextServicesManager;
    ...
    iput-object v8, p0, Lcom/android/settings_ext/inputmethod/SpellCheckersSettings;->mCurrentSci:Landroid/view/textservice/SpellCheckerInfo;
    ...
    iget-object v8, p0, Lcom/android/settings_ext/inputmethod/SpellCheckersSettings;->mSwitchBar:Lcom/android/settings_ext/widget/SwitchBar;

    invoke-virtual {v8, v3}, Lcom/android/settings_ext/widget/SwitchBar;->setChecked(Z)V
    ...
    iget-object v8, p0, Lcom/android/settings_ext/inputmethod/SpellCheckersSettings;->mSpellCheckerLanaguagePref:Landroid/preference/Preference;

    iget-object v10, p0, Lcom/android/settings_ext/inputmethod/SpellCheckersSettings;->mCurrentSci:Landroid/view/textservice/SpellCheckerInfo;

    invoke-direct {p0, v10, v1}, Lcom/android/settings_ext/inputmethod/SpellCheckersSettings;->getSpellCheckerSubtypeLabel(Landroid/view/textservice/SpellCheckerInfo;Landroid/view/textservice/SpellCheckerSubtype;)Ljava/lang/CharSequence;
    ...
    .line 117
    instance-of v8, v5, Lcom/android/settings_ext/inputmethod/SpellCheckerPreference;
    ...
    .line 118
    check-cast v4, Lcom/android/settings_ext/inputmethod/SpellCheckerPreference;

    .line 119
    .local v4, "pref":Lcom/android/settings_ext/inputmethod/SpellCheckerPreference;
    invoke-virtual {v4}, Lcom/android/settings_ext/inputmethod/SpellCheckerPreference;->getSpellCheckerInfo()Landroid/view/textservice/SpellCheckerInfo;

    move-result-object v6

    .line 120
    .local v6, "sci":Landroid/view/textservice/SpellCheckerInfo;
    iget-object v8, p0, Lcom/android/settings_ext/inputmethod/SpellCheckersSettings;->mCurrentSci:Landroid/view/textservice/SpellCheckerInfo;
    ...
    :goto_1
    invoke-virtual {v4, v8}, Lcom/android/settings_ext/inputmethod/SpellCheckerPreference;->setSelected(Z)V

    .line 114
    .end local v4    # "pref":Lcom/android/settings_ext/inputmethod/SpellCheckerPreference;
    ...
    .restart local v4    # "pref":Lcom/android/settings_ext/inputmethod/SpellCheckerPreference;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings_ext/inputmethod/SpellCheckersSettings;->mSpellCheckerLanaguagePref:Landroid/preference/Preference;

    .line 62
    iget-object v0, p0, Lcom/android/settings_ext/inputmethod/SpellCheckersSettings;->mSpellCheckerLanaguagePref:Landroid/preference/Preference;
    ...
    iput-object v0, p0, Lcom/android/settings_ext/inputmethod/SpellCheckersSettings;->mTsm:Landroid/view/textservice/TextServicesManager;
    ...
    iput-object v0, p0, Lcom/android/settings_ext/inputmethod/SpellCheckersSettings;->mCurrentSci:Landroid/view/textservice/SpellCheckerInfo;
    ...
    iput-object v0, p0, Lcom/android/settings_ext/inputmethod/SpellCheckersSettings;->mEnabledScis:[Landroid/view/textservice/SpellCheckerInfo;

    .line 67
    invoke-direct {p0}, Lcom/android/settings_ext/inputmethod/SpellCheckersSettings;->populatePreferenceScreen()V
...
.method public onPause()V
    ...
    .line 94
    iget-object v0, p0, Lcom/android/settings_ext/inputmethod/SpellCheckersSettings;->mSwitchBar:Lcom/android/settings_ext/widget/SwitchBar;
...
.method public onPreferenceClick(Landroid/preference/Preference;)Z
    ...
    .line 140
    invoke-direct {p0}, Lcom/android/settings_ext/inputmethod/SpellCheckersSettings;->showChooseLanguageDialog()V
...
.method public onRadioButtonClicked(Lcom/android/settings_ext/inputmethod/SpellCheckerPreference;)V
    .locals 3
    .param p1, "pref"    # Lcom/android/settings_ext/inputmethod/SpellCheckerPreference;
    ...
    .line 152
    invoke-direct {p0, v1}, Lcom/android/settings_ext/inputmethod/SpellCheckersSettings;->changeCurrentSpellChecker(Landroid/view/textservice/SpellCheckerInfo;)V
    ...
    :cond_1
    invoke-direct {p0, p1}, Lcom/android/settings_ext/inputmethod/SpellCheckersSettings;->showSecurityWarnDialog(Lcom/android/settings_ext/inputmethod/SpellCheckerPreference;)V
...
.method public onResume()V
    ...
    iput-object v0, p0, Lcom/android/settings_ext/inputmethod/SpellCheckersSettings;->mSwitchBar:Lcom/android/settings_ext/widget/SwitchBar;
