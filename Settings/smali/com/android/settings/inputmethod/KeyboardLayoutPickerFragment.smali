.class public Lcom/android/settings_ext/inputmethod/KeyboardLayoutPickerFragment;
...
.method public constructor <init>()V
    ...
    iput v0, p0, Lcom/android/settings_ext/inputmethod/KeyboardLayoutPickerFragment;->mInputDeviceId:I
    ...
    iput-object v0, p0, Lcom/android/settings_ext/inputmethod/KeyboardLayoutPickerFragment;->mPreferenceMap:Ljava/util/HashMap;
...
.method private createPreferenceHierarchy()Landroid/preference/PreferenceScreen;
    ...
    .prologue
    .line 133
    invoke-virtual {p0}, Lcom/android/settings_ext/inputmethod/KeyboardLayoutPickerFragment;->getPreferenceManager()Landroid/preference/PreferenceManager;

    move-result-object v7

    invoke-virtual {p0}, Lcom/android/settings_ext/inputmethod/KeyboardLayoutPickerFragment;->getActivity()Landroid/app/Activity;
    ...
    iget-object v0, p0, Lcom/android/settings_ext/inputmethod/KeyboardLayoutPickerFragment;->mKeyboardLayouts:[Landroid/hardware/input/KeyboardLayout;
    ...
    .line 141
    iget-object v7, p0, Lcom/android/settings_ext/inputmethod/KeyboardLayoutPickerFragment;->mPreferenceMap:Ljava/util/HashMap;
...
.method private updateCheckedState()V
    ...
    .prologue
    .line 147
    iget-object v3, p0, Lcom/android/settings_ext/inputmethod/KeyboardLayoutPickerFragment;->mIm:Landroid/hardware/input/InputManager;

    iget-object v4, p0, Lcom/android/settings_ext/inputmethod/KeyboardLayoutPickerFragment;->mInputDeviceIdentifier:Landroid/hardware/input/InputDeviceIdentifier;
    ...
    .line 151
    iget-object v3, p0, Lcom/android/settings_ext/inputmethod/KeyboardLayoutPickerFragment;->mPreferenceMap:Ljava/util/HashMap;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings_ext/inputmethod/KeyboardLayoutPickerFragment;->mInputDeviceIdentifier:Landroid/hardware/input/InputDeviceIdentifier;

    .line 58
    iget-object v0, p0, Lcom/android/settings_ext/inputmethod/KeyboardLayoutPickerFragment;->mInputDeviceIdentifier:Landroid/hardware/input/InputDeviceIdentifier;
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings_ext/inputmethod/KeyboardLayoutPickerFragment;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Landroid/hardware/input/InputManager;

    iput-object v0, p0, Lcom/android/settings_ext/inputmethod/KeyboardLayoutPickerFragment;->mIm:Landroid/hardware/input/InputManager;

    .line 63
    iget-object v0, p0, Lcom/android/settings_ext/inputmethod/KeyboardLayoutPickerFragment;->mIm:Landroid/hardware/input/InputManager;

    invoke-virtual {v0}, Landroid/hardware/input/InputManager;->getKeyboardLayouts()[Landroid/hardware/input/KeyboardLayout;

    move-result-object v0

    iput-object v0, p0, Lcom/android/settings_ext/inputmethod/KeyboardLayoutPickerFragment;->mKeyboardLayouts:[Landroid/hardware/input/KeyboardLayout;
    ...
    .line 65
    invoke-direct {p0}, Lcom/android/settings_ext/inputmethod/KeyboardLayoutPickerFragment;->createPreferenceHierarchy()Landroid/preference/PreferenceScreen;

    move-result-object v0

    invoke-virtual {p0, v0}, Lcom/android/settings_ext/inputmethod/KeyboardLayoutPickerFragment;->setPreferenceScreen(Landroid/preference/PreferenceScreen;)V
...
.method public onInputDeviceChanged(I)V
    ...
    .prologue
    .line 120
    iget v0, p0, Lcom/android/settings_ext/inputmethod/KeyboardLayoutPickerFragment;->mInputDeviceId:I
    ...
    .line 121
    invoke-direct {p0}, Lcom/android/settings_ext/inputmethod/KeyboardLayoutPickerFragment;->updateCheckedState()V
...
.method public onResume()V
    ...
    .line 72
    iget-object v1, p0, Lcom/android/settings_ext/inputmethod/KeyboardLayoutPickerFragment;->mIm:Landroid/hardware/input/InputManager;
    ...
    iget-object v2, p0, Lcom/android/settings_ext/inputmethod/KeyboardLayoutPickerFragment;->mInputDeviceIdentifier:Landroid/hardware/input/InputDeviceIdentifier;
    ...
    iput v1, p0, Lcom/android/settings_ext/inputmethod/KeyboardLayoutPickerFragment;->mInputDeviceId:I
