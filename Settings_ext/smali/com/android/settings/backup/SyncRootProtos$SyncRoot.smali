...
# static fields
.field private static final Mb:Lcom/android/settings/backup/SyncRootProtos$SyncRoot;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settings/backup/SyncRootProtos$SyncRoot;->Mb:Lcom/android/settings/backup/SyncRootProtos$SyncRoot;

    .line 314
    sget-object v0, Lcom/android/settings/backup/SyncRootProtos$SyncRoot;->Mb:Lcom/android/settings/backup/SyncRootProtos$SyncRoot;

    invoke-direct {v0}, Lcom/android/settings/backup/SyncRootProtos$SyncRoot;->ko()V

    .line 315
    return-void
.end method

.method private constructor <init>(Lcom/android/settings/backup/s;)V
    .locals 1
...
.method synthetic constructor <init>(Lcom/android/settings/backup/s;Lcom/android/settings/backup/r;)V
    .locals 0

    .prologue
    .line 18
    invoke-direct {p0, p1}, Lcom/android/settings/backup/SyncRootProtos$SyncRoot;-><init>(Lcom/android/settings/backup/s;)V
...
.method public static a(Ljava/io/InputStream;)Lcom/android/settings/backup/SyncRootProtos$SyncRoot;
    ...
    invoke-virtual {v0, p0}, Lcom/android/settings/backup/s;->mergeFrom(Ljava/io/InputStream;)Lcom/google/protobuf/AbstractMessageLite$Builder;

    move-result-object v0

    check-cast v0, Lcom/android/settings/backup/s;

    invoke-static {v0}, Lcom/android/settings/backup/s;->a(Lcom/android/settings/backup/s;)Lcom/android/settings/backup/SyncRootProtos$SyncRoot;
...
.method public static a(Lcom/android/settings/backup/SyncRootProtos$SyncRoot;)Lcom/android/settings/backup/s;
    .locals 1
    ...
    invoke-virtual {v0, p0}, Lcom/android/settings/backup/s;->b(Lcom/android/settings/backup/SyncRootProtos$SyncRoot;)Lcom/android/settings/backup/s;
...
.method public static lo()Lcom/android/settings/backup/SyncRootProtos$SyncRoot;
    .locals 1
...
.method public static ls()Lcom/android/settings/backup/s;
    .locals 1

    .prologue
    .line 155
    invoke-static {}, Lcom/android/settings/backup/s;->lB()Lcom/android/settings/backup/s;
...
.method public synthetic getDefaultInstanceForType()Lcom/google/protobuf/MessageLite;
    ...
    .prologue
    .line 18
    invoke-virtual {p0}, Lcom/android/settings/backup/SyncRootProtos$SyncRoot;->lp()Lcom/android/settings/backup/SyncRootProtos$SyncRoot;
...
.method public lt()Lcom/android/settings/backup/s;
    .locals 1
...
.method public lu()Lcom/android/settings/backup/s;
    .locals 1

    .prologue
    .line 160
    invoke-static {p0}, Lcom/android/settings/backup/SyncRootProtos$SyncRoot;->a(Lcom/android/settings/backup/SyncRootProtos$SyncRoot;)Lcom/android/settings/backup/s;
...
.method public synthetic newBuilderForType()Lcom/google/protobuf/MessageLite$Builder;
    ...
    .prologue
    .line 18
    invoke-virtual {p0}, Lcom/android/settings/backup/SyncRootProtos$SyncRoot;->lt()Lcom/android/settings/backup/s;
...
.method public synthetic toBuilder()Lcom/google/protobuf/MessageLite$Builder;
    ...
    .prologue
    .line 18
    invoke-virtual {p0}, Lcom/android/settings/backup/SyncRootProtos$SyncRoot;->lu()Lcom/android/settings/backup/s;
