...
# instance fields
.field private N:Lcom/android/settings/r;
...
.method protected a(Landroid/content/Intent;Ljava/util/List;)V
    ...
    .line 191
    new-instance v5, Lcom/android/settings/s;

    invoke-direct {v5, p0, v2, v0}, Lcom/android/settings/s;-><init>(Landroid/content/Context;Landroid/content/pm/PackageManager;Landroid/content/pm/ResolveInfo;)V
...
.method protected e(I)Landroid/content/Intent;
    ...
    .prologue
    .line 129
    iget-object v0, p0, Lcom/android/settings/ActivityPicker;->N:Lcom/android/settings/r;

    invoke-virtual {v0, p1}, Lcom/android/settings/r;->getItem(I)Ljava/lang/Object;
    ...
    .line 130
    iget-object v1, p0, Lcom/android/settings/ActivityPicker;->O:Landroid/content/Intent;

    invoke-virtual {v0, v1}, Lcom/android/settings/s;->a(Landroid/content/Intent;)Landroid/content/Intent;
...
.method protected getItems()Ljava/util/List;
    ...
    .line 167
    :goto_1
    new-instance v8, Lcom/android/settings/s;

    invoke-direct {v8, p0, v0, v1}, Lcom/android/settings/s;-><init>(Landroid/content/Context;Ljava/lang/CharSequence;Landroid/graphics/drawable/Drawable;)V
    ...
    .line 172
    :cond_0
    iget-object v0, p0, Lcom/android/settings/ActivityPicker;->O:Landroid/content/Intent;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/ActivityPicker;->O:Landroid/content/Intent;
    ...
    invoke-direct {v2, p0, v1}, Lcom/android/settings/r;-><init>(Landroid/content/Context;Ljava/util/List;)V

    iput-object v2, p0, Lcom/android/settings/ActivityPicker;->N:Lcom/android/settings/r;

    .line 101
    iget-object v1, p0, Lcom/android/settings/ActivityPicker;->N:Lcom/android/settings/r;
