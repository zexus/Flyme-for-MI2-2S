...
.field private Mu:Lcom/android/settings/bluetooth/CachedBluetoothDevice;

.field private Mw:Landroid/app/AlertDialog;

.field private NW:Lcom/android/settings/bluetooth/DeviceProfilesSettings$RenameEditTextPreference;

.field private NX:Lcom/android/settings/bluetooth/LocalBluetoothManager;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/DeviceProfilesSettings;->Oa:Ljava/util/HashMap;
...
.method static synthetic a(Lcom/android/settings/bluetooth/DeviceProfilesSettings;)Landroid/preference/EditTextPreference;
    ...
    .prologue
    .line 49
    iget-object v0, p0, Lcom/android/settings/bluetooth/DeviceProfilesSettings;->NZ:Landroid/preference/EditTextPreference;
...
.method private a(Landroid/content/Context;Lcom/android/settings/bluetooth/LocalBluetoothProfile;)V
    ...
    .prologue
    .line 277
    iget-object v1, p0, Lcom/android/settings/bluetooth/DeviceProfilesSettings;->Mu:Lcom/android/settings/bluetooth/CachedBluetoothDevice;
    ...
    invoke-interface {p2, v2}, Lcom/android/settings/bluetooth/LocalBluetoothProfile;->d(Landroid/bluetooth/BluetoothDevice;)I
    ...
    .line 297
    iget-object v1, p0, Lcom/android/settings/bluetooth/DeviceProfilesSettings;->Mw:Landroid/app/AlertDialog;
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/DeviceProfilesSettings;->Mw:Landroid/app/AlertDialog;
...
.method private a(Landroid/preference/CheckBoxPreference;Lcom/android/settings/bluetooth/LocalBluetoothProfile;)V
    ...
    .prologue
    .line 335
    iget-object v0, p0, Lcom/android/settings/bluetooth/DeviceProfilesSettings;->Mu:Lcom/android/settings/bluetooth/CachedBluetoothDevice;
    ...
    invoke-virtual {v0}, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->mt()Z
    ...
    .line 341
    invoke-interface {p2, v1}, Lcom/android/settings/bluetooth/LocalBluetoothProfile;->b(Landroid/bluetooth/BluetoothDevice;)Z
    ...
    .line 342
    invoke-interface {p2, v1}, Lcom/android/settings/bluetooth/LocalBluetoothProfile;->e(Landroid/bluetooth/BluetoothDevice;)I
...
.method private a(Lcom/android/settings/bluetooth/LocalBluetoothProfile;Landroid/preference/CheckBoxPreference;)V
    .locals 5
    ...
    .line 256
    invoke-interface {p1, v3}, Lcom/android/settings/bluetooth/LocalBluetoothProfile;->a(Landroid/bluetooth/BluetoothDevice;)I
    ...
    .line 263
    :cond_1
    invoke-interface {p1, v3}, Lcom/android/settings/bluetooth/LocalBluetoothProfile;->b(Landroid/bluetooth/BluetoothDevice;)Z
    ...
    .line 265
    invoke-interface {p1, v3, v2}, Lcom/android/settings/bluetooth/LocalBluetoothProfile;->a(Landroid/bluetooth/BluetoothDevice;Z)V

    .line 266
    invoke-direct {p0, p2, p1}, Lcom/android/settings/bluetooth/DeviceProfilesSettings;->a(Landroid/preference/CheckBoxPreference;Lcom/android/settings/bluetooth/LocalBluetoothProfile;)V

    goto :goto_1

    .line 268
    :cond_2
    invoke-interface {p1, v3, v1}, Lcom/android/settings/bluetooth/LocalBluetoothProfile;->a(Landroid/bluetooth/BluetoothDevice;Z)V

    .line 269
    iget-object v0, p0, Lcom/android/settings/bluetooth/DeviceProfilesSettings;->Mu:Lcom/android/settings/bluetooth/CachedBluetoothDevice;

    invoke-virtual {v0, p1}, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->c(Lcom/android/settings/bluetooth/LocalBluetoothProfile;)V
...
.method private aY(I)I
    ...
    .prologue
    .line 360
    iget-object v0, p0, Lcom/android/settings/bluetooth/DeviceProfilesSettings;->NY:Landroid/preference/PreferenceGroup;
...
.method private f(Lcom/android/settings/bluetooth/LocalBluetoothProfile;)Landroid/preference/CheckBoxPreference;
    .locals 4
    ...
    .line 207
    iget-object v2, p0, Lcom/android/settings/bluetooth/DeviceProfilesSettings;->Mu:Lcom/android/settings/bluetooth/CachedBluetoothDevice;

    invoke-virtual {v2}, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->getDevice()Landroid/bluetooth/BluetoothDevice;

    move-result-object v2

    invoke-interface {p1, v2}, Lcom/android/settings/bluetooth/LocalBluetoothProfile;->d(Landroid/bluetooth/BluetoothDevice;)I
    ...
    .line 209
    invoke-interface {p1}, Lcom/android/settings/bluetooth/LocalBluetoothProfile;->lF()I

    move-result v2

    invoke-direct {p0, v2}, Lcom/android/settings/bluetooth/DeviceProfilesSettings;->aY(I)I
    ...
    invoke-virtual {v2}, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->my()Landroid/bluetooth/BluetoothClass;
    ...
    invoke-virtual {v2}, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->mt()Z
...
.method private f(Landroid/preference/Preference;)Lcom/android/settings/bluetooth/LocalBluetoothProfile;
    .locals 3
    ...
    .line 353
    :try_start_0
    iget-object v1, p0, Lcom/android/settings/bluetooth/DeviceProfilesSettings;->Mk:Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;

    invoke-virtual {p1}, Landroid/preference/Preference;->getKey()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v1, v2}, Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;->aD(Ljava/lang/String;)Lcom/android/settings/bluetooth/LocalBluetoothProfile;
    :try_end_0
...
.method private mP()V
    ...
    invoke-virtual {v0}, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->mA()Ljava/util/List;
    ...
    .line 179
    invoke-direct {p0, v0}, Lcom/android/settings/bluetooth/DeviceProfilesSettings;->f(Lcom/android/settings/bluetooth/LocalBluetoothProfile;)Landroid/preference/CheckBoxPreference;

    move-result-object v0

    .line 180
    iget-object v2, p0, Lcom/android/settings/bluetooth/DeviceProfilesSettings;->NY:Landroid/preference/PreferenceGroup;
    ...
    .line 182
    :cond_0
    invoke-direct {p0}, Lcom/android/settings/bluetooth/DeviceProfilesSettings;->mQ()V
...
.method private mQ()V
    ...
    .line 187
    iget-boolean v1, p0, Lcom/android/settings/bluetooth/DeviceProfilesSettings;->Ob:Z
    ...
    iget-object v1, p0, Lcom/android/settings/bluetooth/DeviceProfilesSettings;->NY:Landroid/preference/PreferenceGroup;
    ...
    iput-boolean v0, p0, Lcom/android/settings/bluetooth/DeviceProfilesSettings;->Ob:Z
...
.method private mR()V
    ...
    invoke-virtual {v0}, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->mB()Ljava/util/List;
...
.method private mS()V
    ...
    invoke-virtual {v0}, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->mn()V

    .line 366
    iget-object v0, p0, Lcom/android/settings/bluetooth/DeviceProfilesSettings;->NX:Lcom/android/settings/bluetooth/LocalBluetoothManager;
...
.method private refresh()V
    ...
    .line 307
    iget-object v1, p0, Lcom/android/settings/bluetooth/DeviceProfilesSettings;->NZ:Landroid/preference/EditTextPreference;
    ...
    .line 310
    invoke-direct {p0}, Lcom/android/settings/bluetooth/DeviceProfilesSettings;->mR()V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/DeviceProfilesSettings;->NY:Landroid/preference/PreferenceGroup;
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/DeviceProfilesSettings;->NZ:Landroid/preference/EditTextPreference;
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/DeviceProfilesSettings;->NW:Lcom/android/settings/bluetooth/DeviceProfilesSettings$RenameEditTextPreference;
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/DeviceProfilesSettings;->NX:Lcom/android/settings/bluetooth/LocalBluetoothManager;
    ...
    .line 117
    iget-object v2, p0, Lcom/android/settings/bluetooth/DeviceProfilesSettings;->NX:Lcom/android/settings/bluetooth/LocalBluetoothManager;
    ...
    iput-object v2, p0, Lcom/android/settings/bluetooth/DeviceProfilesSettings;->Mk:Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/DeviceProfilesSettings;->Mu:Lcom/android/settings/bluetooth/CachedBluetoothDevice;
    ...
    .line 131
    invoke-direct {p0}, Lcom/android/settings/bluetooth/DeviceProfilesSettings;->mP()V
...
.method public onDestroy()V
    ...
    .line 137
    iget-object v0, p0, Lcom/android/settings/bluetooth/DeviceProfilesSettings;->Mw:Landroid/app/AlertDialog;
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    .line 243
    invoke-direct {p0, p1}, Lcom/android/settings/bluetooth/DeviceProfilesSettings;->f(Landroid/preference/Preference;)Lcom/android/settings/bluetooth/LocalBluetoothProfile;
    ...
    invoke-direct {p0, v1, p1}, Lcom/android/settings/bluetooth/DeviceProfilesSettings;->a(Lcom/android/settings/bluetooth/LocalBluetoothProfile;Landroid/preference/CheckBoxPreference;)V
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    .line 231
    invoke-direct {p0}, Lcom/android/settings/bluetooth/DeviceProfilesSettings;->mS()V
...
.method public onResume()V
    ...
    .line 160
    iget-object v0, p0, Lcom/android/settings/bluetooth/DeviceProfilesSettings;->NW:Lcom/android/settings/bluetooth/DeviceProfilesSettings$RenameEditTextPreference;
