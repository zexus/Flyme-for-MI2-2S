...
.method static constructor <clinit>()V
    ...
    .line 39
    sput-boolean v3, Lcom/android/settings/bluetooth/MapProfile;->Me:Z
    ...
    sput-object v0, Lcom/android/settings/bluetooth/MapProfile;->OE:[Landroid/os/ParcelUuid;
...
.method constructor <init>(Landroid/content/Context;Lcom/android/settings/bluetooth/LocalBluetoothAdapter;Lcom/android/settings/bluetooth/CachedBluetoothDeviceManager;Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;)V
    ...
    .line 99
    iput-object p2, p0, Lcom/android/settings/bluetooth/MapProfile;->Mh:Lcom/android/settings/bluetooth/LocalBluetoothAdapter;

    .line 100
    iput-object p3, p0, Lcom/android/settings/bluetooth/MapProfile;->Mi:Lcom/android/settings/bluetooth/CachedBluetoothDeviceManager;

    .line 101
    iput-object p4, p0, Lcom/android/settings/bluetooth/MapProfile;->Mk:Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;

    .line 102
    iget-object v0, p0, Lcom/android/settings/bluetooth/MapProfile;->Mh:Lcom/android/settings/bluetooth/LocalBluetoothAdapter;
...
.method static synthetic a(Lcom/android/settings/bluetooth/MapProfile;)Landroid/bluetooth/BluetoothMap;
    .locals 1

    .prologue
    .line 37
    iget-object v0, p0, Lcom/android/settings/bluetooth/MapProfile;->OZ:Landroid/bluetooth/BluetoothMap;

    return-object v0
.end method

.method static synthetic a(Lcom/android/settings/bluetooth/MapProfile;Landroid/bluetooth/BluetoothMap;)Landroid/bluetooth/BluetoothMap;
    .locals 0

    .prologue
    .line 37
    iput-object p1, p0, Lcom/android/settings/bluetooth/MapProfile;->OZ:Landroid/bluetooth/BluetoothMap;

    return-object p1
.end method

.method static synthetic a(Lcom/android/settings/bluetooth/MapProfile;Z)Z
    .locals 0

    .prologue
    .line 37
    iput-boolean p1, p0, Lcom/android/settings/bluetooth/MapProfile;->Mg:Z
...
.method static synthetic access$000()Z
    ...
    .prologue
    .line 37
    sget-boolean v0, Lcom/android/settings/bluetooth/MapProfile;->Me:Z

    return v0
.end method

.method static synthetic b(Lcom/android/settings/bluetooth/MapProfile;)Lcom/android/settings/bluetooth/CachedBluetoothDeviceManager;
    .locals 1

    .prologue
    .line 37
    iget-object v0, p0, Lcom/android/settings/bluetooth/MapProfile;->Mi:Lcom/android/settings/bluetooth/CachedBluetoothDeviceManager;

    return-object v0
.end method

.method static synthetic c(Lcom/android/settings/bluetooth/MapProfile;)Lcom/android/settings/bluetooth/LocalBluetoothAdapter;
    .locals 1
...
.method static synthetic d(Lcom/android/settings/bluetooth/MapProfile;)Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;
    .locals 1

    .prologue
    .line 37
    iget-object v0, p0, Lcom/android/settings/bluetooth/MapProfile;->Mk:Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;
...
.method public a(Landroid/bluetooth/BluetoothDevice;)I
    ...
    .line 135
    sget-boolean v2, Lcom/android/settings/bluetooth/MapProfile;->Me:Z
    ...
    iget-object v4, p0, Lcom/android/settings/bluetooth/MapProfile;->OZ:Landroid/bluetooth/BluetoothMap;
...
.method public b(Landroid/bluetooth/BluetoothDevice;)Z
    ...
    .line 143
    iget-object v1, p0, Lcom/android/settings/bluetooth/MapProfile;->OZ:Landroid/bluetooth/BluetoothMap;
...
.method public e(Landroid/bluetooth/BluetoothDevice;)I
    ...
    .prologue
    .line 184
    invoke-virtual {p0, p1}, Lcom/android/settings/bluetooth/MapProfile;->a(Landroid/bluetooth/BluetoothDevice;)I
...
.method protected finalize()V
    ...
    iget-object v2, p0, Lcom/android/settings/bluetooth/MapProfile;->OZ:Landroid/bluetooth/BluetoothMap;
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/MapProfile;->OZ:Landroid/bluetooth/BluetoothMap;
    :try_end_0
...
.method public lC()Z
    ...
    iget-boolean v2, p0, Lcom/android/settings/bluetooth/MapProfile;->Mg:Z
    ...
    .line 93
    :cond_0
    iget-boolean v0, p0, Lcom/android/settings/bluetooth/MapProfile;->Mg:Z
