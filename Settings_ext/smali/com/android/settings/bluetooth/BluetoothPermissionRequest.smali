...
.method public constructor <init>()V
    ...
    .line 49
    iput-object v0, p0, Lcom/android/settings/bluetooth/BluetoothPermissionRequest;->Nc:Ljava/lang/String;

    .line 50
    iput-object v0, p0, Lcom/android/settings/bluetooth/BluetoothPermissionRequest;->Nd:Ljava/lang/String;
...
.method private aS(I)Ljava/lang/String;
    ...
    .line 186
    :cond_0
    iget v0, p0, Lcom/android/settings/bluetooth/BluetoothPermissionRequest;->Ne:I
...
.method private an(Z)V
    ...
    .line 254
    iget-object v0, p0, Lcom/android/settings/bluetooth/BluetoothPermissionRequest;->Nc:Ljava/lang/String;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/android/settings/bluetooth/BluetoothPermissionRequest;->Nd:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/android/settings/bluetooth/BluetoothPermissionRequest;->Nd:Ljava/lang/String;
    ...
    iget v2, p0, Lcom/android/settings/bluetooth/BluetoothPermissionRequest;->Ne:I
...
.method private mg()Z
    ...
    invoke-virtual {v4, v0}, Lcom/android/settings/bluetooth/CachedBluetoothDeviceManager;->h(Landroid/bluetooth/BluetoothDevice;)Lcom/android/settings/bluetooth/CachedBluetoothDevice;
    ...
    .line 212
    invoke-virtual {v3}, Lcom/android/settings/bluetooth/LocalBluetoothManager;->nb()Lcom/android/settings/bluetooth/LocalBluetoothAdapter;

    move-result-object v0

    invoke-virtual {v3}, Lcom/android/settings/bluetooth/LocalBluetoothManager;->ng()Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;
    ...
    .line 218
    iget v3, p0, Lcom/android/settings/bluetooth/BluetoothPermissionRequest;->Ne:I

    if-ne v3, v6, :cond_6

    .line 219
    invoke-virtual {v0}, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->mD()I
    ...
    .line 224
    invoke-direct {p0, v2}, Lcom/android/settings/bluetooth/BluetoothPermissionRequest;->an(Z)V
    ...
    .line 227
    invoke-direct {p0, v1}, Lcom/android/settings/bluetooth/BluetoothPermissionRequest;->an(Z)V
    ...
    .line 233
    invoke-virtual {v0}, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->mF()I
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    iput v0, p0, Lcom/android/settings/bluetooth/BluetoothPermissionRequest;->Ne:I
    ...
    .line 86
    invoke-direct {p0}, Lcom/android/settings/bluetooth/BluetoothPermissionRequest;->mg()Z
    ...
    iget v1, p0, Lcom/android/settings/bluetooth/BluetoothPermissionRequest;->Ne:I
    ...
    iget-object v1, p0, Lcom/android/settings/bluetooth/BluetoothPermissionRequest;->Nc:Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/android/settings/bluetooth/BluetoothPermissionRequest;->Nd:Ljava/lang/String;
    ...
    invoke-static {p1, v1}, Lcom/android/settings/bluetooth/LocalBluetoothPreferences;->k(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v2}, Lcom/android/settings/bluetooth/BluetoothPermissionRequest;->aS(I)Ljava/lang/String;
    ...
    iput v1, p0, Lcom/android/settings/bluetooth/BluetoothPermissionRequest;->Ne:I

    .line 179
    iget v1, p0, Lcom/android/settings/bluetooth/BluetoothPermissionRequest;->Ne:I

    invoke-direct {p0, v1}, Lcom/android/settings/bluetooth/BluetoothPermissionRequest;->aS(I)Ljava/lang/String;
