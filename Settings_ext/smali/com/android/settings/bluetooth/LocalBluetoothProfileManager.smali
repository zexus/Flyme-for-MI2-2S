...
.field private final OM:Lcom/android/settings/bluetooth/BluetoothEventManager;

.field private ON:Lcom/android/settings/bluetooth/A2dpProfile;

.field private OO:Lcom/android/settings/bluetooth/A2dpSinkProfile;

.field private OP:Lcom/android/settings/bluetooth/HeadsetProfile;

.field private OQ:Lcom/android/settings/bluetooth/MapProfile;

.field private final OR:Lcom/android/settings/bluetooth/HidProfile;

.field private OS:Lcom/android/settings/bluetooth/OppProfile;

.field private final OT:Lcom/android/settings/bluetooth/PanProfile;

.field private final OU:Lcom/android/settings/bluetooth/PbapServerProfile;
...
.method constructor <init>(Landroid/content/Context;Lcom/android/settings/bluetooth/LocalBluetoothAdapter;Lcom/android/settings/bluetooth/CachedBluetoothDeviceManager;Lcom/android/settings/bluetooth/BluetoothEventManager;)V
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;->OV:Ljava/util/Map;
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;->OW:Ljava/util/Collection;

    .line 102
    iput-object p1, p0, Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;->mContext:Landroid/content/Context;

    .line 104
    iput-object p2, p0, Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;->Mh:Lcom/android/settings/bluetooth/LocalBluetoothAdapter;

    .line 105
    iput-object p3, p0, Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;->Mi:Lcom/android/settings/bluetooth/CachedBluetoothDeviceManager;

    .line 106
    iput-object p4, p0, Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;->OM:Lcom/android/settings/bluetooth/BluetoothEventManager;

    .line 108
    iget-object v0, p0, Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;->Mh:Lcom/android/settings/bluetooth/LocalBluetoothAdapter;
    ...
    .line 109
    iget-object v0, p0, Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;->OM:Lcom/android/settings/bluetooth/BluetoothEventManager;
    ...
    iget-object v1, p0, Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;->Mh:Lcom/android/settings/bluetooth/LocalBluetoothAdapter;

    iget-object v2, p0, Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;->Mi:Lcom/android/settings/bluetooth/CachedBluetoothDeviceManager;

    invoke-direct {v0, p1, v1, v2, p0}, Lcom/android/settings/bluetooth/HidProfile;-><init>(Landroid/content/Context;Lcom/android/settings/bluetooth/LocalBluetoothAdapter;Lcom/android/settings/bluetooth/CachedBluetoothDeviceManager;Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;)V

    iput-object v0, p0, Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;->OR:Lcom/android/settings/bluetooth/HidProfile;

    .line 120
    iget-object v0, p0, Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;->OR:Lcom/android/settings/bluetooth/HidProfile;
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;->OT:Lcom/android/settings/bluetooth/PanProfile;

    .line 124
    iget-object v0, p0, Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;->OT:Lcom/android/settings/bluetooth/PanProfile;
    ...
    iget-object v2, p0, Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;->Mh:Lcom/android/settings/bluetooth/LocalBluetoothAdapter;

    iget-object v3, p0, Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;->Mi:Lcom/android/settings/bluetooth/CachedBluetoothDeviceManager;
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;->OQ:Lcom/android/settings/bluetooth/MapProfile;

    .line 130
    iget-object v0, p0, Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;->OQ:Lcom/android/settings/bluetooth/MapProfile;
    ...
    invoke-direct {v0, p1}, Lcom/android/settings/bluetooth/PbapServerProfile;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;->OU:Lcom/android/settings/bluetooth/PbapServerProfile;
...
.method private a(Lcom/android/settings/bluetooth/LocalBluetoothProfile;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 208
    iget-object v0, p0, Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;->OV:Ljava/util/Map;
...
.method static synthetic b(Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;)Lcom/android/settings/bluetooth/CachedBluetoothDeviceManager;
    ...
    .prologue
    .line 48
    iget-object v0, p0, Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;->Mi:Lcom/android/settings/bluetooth/CachedBluetoothDeviceManager;
...
.method a(Lcom/android/settings/bluetooth/LocalBluetoothProfileManager$ServiceListener;)V
    ...
    .prologue
    .line 278
    iget-object v0, p0, Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;->OW:Ljava/util/Collection;
...
.method a([Landroid/os/ParcelUuid;)V
    ...
    .line 151
    iget-object v0, p0, Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;->ON:Lcom/android/settings/bluetooth/A2dpProfile;
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;->ON:Lcom/android/settings/bluetooth/A2dpProfile;
    ...
    .line 162
    iget-object v0, p0, Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;->OO:Lcom/android/settings/bluetooth/A2dpSinkProfile;
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;->OO:Lcom/android/settings/bluetooth/A2dpSinkProfile;
    ...
    .line 175
    :cond_2
    iget-object v0, p0, Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;->OP:Lcom/android/settings/bluetooth/HeadsetProfile;
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;->OP:Lcom/android/settings/bluetooth/HeadsetProfile;
    ...
    .line 188
    iget-object v0, p0, Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;->OS:Lcom/android/settings/bluetooth/OppProfile;
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;->OS:Lcom/android/settings/bluetooth/OppProfile;
    ...
    iget-object v2, p0, Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;->OS:Lcom/android/settings/bluetooth/OppProfile;
    ...
    invoke-virtual {v0}, Lcom/android/settings/bluetooth/BluetoothEventManager;->lQ()V
...
.method declared-synchronized a([Landroid/os/ParcelUuid;[Landroid/os/ParcelUuid;Ljava/util/Collection;Ljava/util/Collection;ZLandroid/bluetooth/BluetoothDevice;)V
    ...
    .line 383
    :cond_5
    sget-object v0, Lcom/android/settings/bluetooth/A2dpSinkProfile;->Mn:[Landroid/os/ParcelUuid;
    ...
    invoke-virtual {v0, p6}, Lcom/android/settings/bluetooth/MapProfile;->a(Landroid/bluetooth/BluetoothDevice;)I
    ...
    invoke-virtual {v0, p6, v1}, Lcom/android/settings/bluetooth/MapProfile;->a(Landroid/bluetooth/BluetoothDevice;Z)V
    :try_end_1
...
.method aD(Ljava/lang/String;)Lcom/android/settings/bluetooth/LocalBluetoothProfile;
    .locals 1
...
.method public declared-synchronized nk()Z
    ...
    .line 306
    invoke-interface {v0}, Lcom/android/settings/bluetooth/LocalBluetoothProfile;->lC()Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method nl()Lcom/android/settings/bluetooth/A2dpProfile;
    .locals 1
    ...
    invoke-virtual {v0}, Lcom/android/settings/bluetooth/A2dpProfile;->lC()Z
...
.method nm()Lcom/android/settings/bluetooth/HeadsetProfile;
    .locals 1
...
.method nn()Lcom/android/settings/bluetooth/PbapServerProfile;
    .locals 1

    .prologue
    .line 338
    iget-object v0, p0, Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;->OU:Lcom/android/settings/bluetooth/PbapServerProfile;
