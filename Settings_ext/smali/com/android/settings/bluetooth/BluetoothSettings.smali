...
# instance fields
.field protected Ni:Lcom/android/settings/bluetooth/MiuiBluetoothEnabler;

.field Nj:Landroid/preference/CheckBoxPreference;

.field Nk:Lcom/android/settings/bluetooth/MiuiBluetoothDiscoverableEnabler;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settings/bluetooth/BluetoothSettings;->Nh:Landroid/view/View;
    ...
    sput-object v0, Lcom/android/settings/bluetooth/BluetoothSettings;->gG:Lcom/android/settings/search/l;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/BluetoothSettings;->Ns:Landroid/view/View$OnClickListener;
...
.method private a(Landroid/preference/PreferenceGroup;ILcom/android/settings/bluetooth/BluetoothDeviceFilter$Filter;Z)V
    .locals 1
    ...
    .line 314
    invoke-virtual {p0}, Lcom/android/settings/bluetooth/BluetoothSettings;->mN()V
...
.method static synthetic a(Lcom/android/settings/bluetooth/BluetoothSettings;Z)Z
    ...
    .prologue
    .line 77
    iput-boolean p1, p0, Lcom/android/settings/bluetooth/BluetoothSettings;->Np:Z
...
.method private mi()V
    ...
    .line 275
    invoke-virtual {p0}, Lcom/android/settings/bluetooth/BluetoothSettings;->gy()Z
    ...
    .line 279
    :cond_0
    iget-boolean v0, p0, Lcom/android/settings/bluetooth/BluetoothSettings;->Nn:Z
    ...
    iget-object v1, p0, Lcom/android/settings/bluetooth/BluetoothSettings;->Nm:Landroid/preference/PreferenceGroup;

    invoke-virtual {v0, v1}, Landroid/preference/PreferenceScreen;->addPreference(Landroid/preference/Preference;)Z

    .line 281
    iput-boolean v2, p0, Lcom/android/settings/bluetooth/BluetoothSettings;->Nn:Z

    .line 284
    :cond_1
    iget-object v0, p0, Lcom/android/settings/bluetooth/BluetoothSettings;->Nm:Landroid/preference/PreferenceGroup;
    ...
    .line 286
    invoke-virtual {p0}, Lcom/android/settings/bluetooth/BluetoothSettings;->mM()V

    .line 289
    :cond_2
    iget-object v0, p0, Lcom/android/settings/bluetooth/BluetoothSettings;->NO:Lcom/android/settings/bluetooth/LocalBluetoothManager;
    ...
    invoke-virtual {v0}, Lcom/android/settings/bluetooth/CachedBluetoothDeviceManager;->mL()V
    ...
    .line 291
    iput-boolean v2, p0, Lcom/android/settings/bluetooth/BluetoothSettings;->No:Z
...
.method public a(Lcom/android/settings/bluetooth/CachedBluetoothDevice;I)V
    ...
    .line 452
    iget-object v0, p0, Lcom/android/settings/bluetooth/BluetoothSettings;->Mh:Lcom/android/settings/bluetooth/LocalBluetoothAdapter;

    invoke-virtual {v0}, Lcom/android/settings/bluetooth/LocalBluetoothAdapter;->mY()I

    move-result v0

    invoke-virtual {p0, v0}, Lcom/android/settings/bluetooth/BluetoothSettings;->aT(I)V
...
.method public aL(I)V
    ...
    .prologue
    .line 436
    invoke-super {p0, p1}, Lcom/android/settings/bluetooth/DeviceListPreferenceFragment;->aL(I)V

    .line 437
    invoke-virtual {p0, p1}, Lcom/android/settings/bluetooth/BluetoothSettings;->aT(I)V
...
.method protected aT(I)V
    ...
    .line 330
    iget-object v1, p0, Lcom/android/settings/bluetooth/BluetoothSettings;->NQ:Ljava/util/WeakHashMap;
    ...
    .line 338
    iget-object v1, p0, Lcom/android/settings/bluetooth/BluetoothSettings;->Nl:Landroid/preference/PreferenceGroup;
    ...
    iput-object v1, p0, Lcom/android/settings/bluetooth/BluetoothSettings;->Nl:Landroid/preference/PreferenceGroup;
    ...
    sget-object v3, Lcom/android/settings/bluetooth/BluetoothDeviceFilter;->Mq:Lcom/android/settings/bluetooth/BluetoothDeviceFilter$Filter;

    invoke-direct {p0, v1, v2, v3, v4}, Lcom/android/settings/bluetooth/BluetoothSettings;->a(Landroid/preference/PreferenceGroup;ILcom/android/settings/bluetooth/BluetoothDeviceFilter$Filter;Z)V
    ...
    .line 349
    :cond_2
    iget-object v2, p0, Lcom/android/settings/bluetooth/BluetoothSettings;->Nl:Landroid/preference/PreferenceGroup;
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/BluetoothSettings;->Nm:Landroid/preference/PreferenceGroup;
    ...
    sget-object v3, Lcom/android/settings/bluetooth/BluetoothDeviceFilter;->Mr:Lcom/android/settings/bluetooth/BluetoothDeviceFilter$Filter;

    iget-boolean v4, p0, Lcom/android/settings/bluetooth/BluetoothSettings;->No:Z

    invoke-direct {p0, v0, v2, v3, v4}, Lcom/android/settings/bluetooth/BluetoothSettings;->a(Landroid/preference/PreferenceGroup;ILcom/android/settings/bluetooth/BluetoothDeviceFilter$Filter;Z)V
    ...
    .line 366
    iget-boolean v0, p0, Lcom/android/settings/bluetooth/BluetoothSettings;->No:Z

    if-nez v0, :cond_4

    .line 367
    invoke-direct {p0}, Lcom/android/settings/bluetooth/BluetoothSettings;->mi()V

    .line 370
    :cond_4
    iget-object v0, p0, Lcom/android/settings/bluetooth/BluetoothSettings;->Nr:Landroid/preference/CheckBoxPreference;
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/BluetoothSettings;->Nr:Landroid/preference/CheckBoxPreference;

    .line 382
    :cond_5
    iget-object v0, p0, Lcom/android/settings/bluetooth/BluetoothSettings;->Nk:Lcom/android/settings/bluetooth/MiuiBluetoothDiscoverableEnabler;
    ...
    invoke-virtual {v0, v1}, Lcom/android/settings/bluetooth/MiuiBluetoothDiscoverableEnabler;->aP(I)V

    .line 385
    :cond_6
    iget-object v0, p0, Lcom/android/settings/bluetooth/BluetoothSettings;->Nr:Landroid/preference/CheckBoxPreference;

    iget-object v1, p0, Lcom/android/settings/bluetooth/BluetoothSettings;->Mh:Lcom/android/settings/bluetooth/LocalBluetoothAdapter;
    ...
    .line 392
    iget-boolean v0, p0, Lcom/android/settings/bluetooth/BluetoothSettings;->Np:Z

    if-eqz v0, :cond_1

    .line 396
    iput-boolean v5, p0, Lcom/android/settings/bluetooth/BluetoothSettings;->Np:Z
    ...
    .line 419
    :pswitch_3
    iput-boolean v5, p0, Lcom/android/settings/bluetooth/BluetoothSettings;->No:Z
...
.method public al(Z)V
    ...
    .prologue
    .line 442
    invoke-super {p0, p1}, Lcom/android/settings/bluetooth/DeviceListPreferenceFragment;->al(Z)V
...
.method e(Lcom/android/settings/bluetooth/BluetoothDevicePreference;)V
    ...
    .line 582
    iget-object v0, p0, Lcom/android/settings/bluetooth/BluetoothSettings;->Ns:Landroid/view/View$OnClickListener;
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    :goto_0
    iput-boolean v0, p0, Lcom/android/settings/bluetooth/BluetoothSettings;->No:Z

    .line 155
    iput-boolean v1, p0, Lcom/android/settings/bluetooth/BluetoothSettings;->Np:Z
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/BluetoothSettings;->Nq:Landroid/widget/TextView;
    ...
    iget-object v1, p0, Lcom/android/settings/bluetooth/BluetoothSettings;->Nq:Landroid/widget/TextView;
...
.method public onCreateOptionsMenu(Landroid/view/Menu;Landroid/view/MenuInflater;)V
    ...
    .line 232
    :goto_1
    iget-object v3, p0, Lcom/android/settings/bluetooth/BluetoothSettings;->Mh:Lcom/android/settings/bluetooth/LocalBluetoothAdapter;
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    invoke-virtual {v1}, Lcom/android/settings/bluetooth/LocalBluetoothAdapter;->mX()V
...
.method public onPause()V
    ...
    .line 210
    iget-object v0, p0, Lcom/android/settings/bluetooth/BluetoothSettings;->Ni:Lcom/android/settings/bluetooth/MiuiBluetoothEnabler;
...
.method public onResume()V
    ...
    iput-boolean v0, p0, Lcom/android/settings/bluetooth/BluetoothSettings;->Np:Z
    ...
    .line 197
    iget-object v0, p0, Lcom/android/settings/bluetooth/BluetoothSettings;->Nq:Landroid/widget/TextView;
