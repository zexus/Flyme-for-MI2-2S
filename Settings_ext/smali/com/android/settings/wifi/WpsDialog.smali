...
.field axs:Lcom/android/settings/wifi/WpsDialog$DialogState;
...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    iput-object v0, p0, Lcom/android/settings/wifi/WpsDialog;->axr:Ljava/lang/String;

    .line 77
    sget-object v0, Lcom/android/settings/wifi/WpsDialog$DialogState;->axy:Lcom/android/settings/wifi/WpsDialog$DialogState;

    iput-object v0, p0, Lcom/android/settings/wifi/WpsDialog;->axs:Lcom/android/settings/wifi/WpsDialog$DialogState;

    .line 81
    iput-object p1, p0, Lcom/android/settings/wifi/WpsDialog;->mContext:Landroid/content/Context;

    .line 82
    iput p2, p0, Lcom/android/settings/wifi/WpsDialog;->axq:I
    ...
    iput-object v0, p0, Lcom/android/settings/wifi/WpsDialog;->axp:Landroid/net/wifi/WifiManager$WpsCallback;
    ...
    iput-object v0, p0, Lcom/android/settings/wifi/WpsDialog;->asr:Landroid/content/IntentFilter;

    .line 128
    iget-object v0, p0, Lcom/android/settings/wifi/WpsDialog;->asr:Landroid/content/IntentFilter;
...
.method private a(Lcom/android/settings/wifi/WpsDialog$DialogState;Ljava/lang/String;)V
    ...
    .prologue
    .line 228
    iget-object v0, p0, Lcom/android/settings/wifi/WpsDialog;->axs:Lcom/android/settings/wifi/WpsDialog$DialogState;
    ...
    .line 232
    :cond_0
    iput-object p1, p0, Lcom/android/settings/wifi/WpsDialog;->axs:Lcom/android/settings/wifi/WpsDialog$DialogState;

    .line 233
    iput-object p2, p0, Lcom/android/settings/wifi/WpsDialog;->axr:Ljava/lang/String;
...
.method static synthetic a(Lcom/android/settings/wifi/WpsDialog;Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .prologue
    .line 44
    invoke-direct {p0, p1, p2}, Lcom/android/settings/wifi/WpsDialog;->f(Landroid/content/Context;Landroid/content/Intent;)V
...
.method static synthetic b(Lcom/android/settings/wifi/WpsDialog;)Landroid/widget/ProgressBar;
    ...
    .prologue
    .line 44
    iget-object v0, p0, Lcom/android/settings/wifi/WpsDialog;->axn:Landroid/widget/ProgressBar;
...
.method static synthetic e(Lcom/android/settings/wifi/WpsDialog;)Landroid/widget/Button;
    ...
    .prologue
    .line 44
    iget-object v0, p0, Lcom/android/settings/wifi/WpsDialog;->eN:Landroid/widget/Button;
...
.method private f(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 267
    iget-object v0, p0, Lcom/android/settings/wifi/WpsDialog;->hD:Landroid/net/wifi/WifiManager;
...
.method static synthetic g(Lcom/android/settings/wifi/WpsDialog;)Landroid/widget/TextView;
    ...
    .prologue
    .line 44
    iget-object v0, p0, Lcom/android/settings/wifi/WpsDialog;->arP:Landroid/widget/TextView;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/wifi/WpsDialog;->arP:Landroid/widget/TextView;
    ...
    iput-object v0, p0, Lcom/android/settings/wifi/WpsDialog;->axn:Landroid/widget/ProgressBar;
    ...
    iput-object v0, p0, Lcom/android/settings/wifi/WpsDialog;->eN:Landroid/widget/Button;
    ...
    iput-object v0, p0, Lcom/android/settings/wifi/WpsDialog;->hD:Landroid/net/wifi/WifiManager;
...
.method public onSaveInstanceState()Landroid/os/Bundle;
    ...
    iget-object v2, p0, Lcom/android/settings/wifi/WpsDialog;->axs:Lcom/android/settings/wifi/WpsDialog$DialogState;
    ...
    iget-object v2, p0, Lcom/android/settings/wifi/WpsDialog;->axr:Ljava/lang/String;
...
.method protected onStart()V
    ...
    iput-object v0, p0, Lcom/android/settings/wifi/WpsDialog;->axo:Ljava/util/Timer;

    .line 191
    iget-object v0, p0, Lcom/android/settings/wifi/WpsDialog;->axo:Ljava/util/Timer;
    ...
    iget-object v2, p0, Lcom/android/settings/wifi/WpsDialog;->asr:Landroid/content/IntentFilter;
    ...
    .line 207
    iget v1, p0, Lcom/android/settings/wifi/WpsDialog;->axq:I

    iput v1, v0, Landroid/net/wifi/WpsInfo;->setup:I

    .line 208
    iget-object v1, p0, Lcom/android/settings/wifi/WpsDialog;->hD:Landroid/net/wifi/WifiManager;

    iget-object v2, p0, Lcom/android/settings/wifi/WpsDialog;->axp:Landroid/net/wifi/WifiManager$WpsCallback;
