...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settings/deviceinfo/Memory;->gG:Lcom/android/settings/search/l;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/settings/deviceinfo/Memory;->RK:Landroid/content/BroadcastReceiver;

    .line 487
    return-void
.end method

.method static synthetic a(Lcom/android/settings/deviceinfo/Memory;)Ljava/util/ArrayList;
    .locals 1
...
.method static synthetic a(Lcom/android/settings/deviceinfo/Memory;I)V
    .locals 0

    .prologue
    .line 69
    invoke-direct {p0, p1}, Lcom/android/settings/deviceinfo/Memory;->bj(I)V

    return-void
.end method

.method private a(Lcom/android/settings/deviceinfo/StorageVolumePreferenceCategory;)V
    .locals 1
...
.method static synthetic access$300()Ljava/lang/String;
    ...
    .prologue
    .line 69
    sget-object v0, Lcom/android/settings/deviceinfo/Memory;->RI:Ljava/lang/String;

    return-object v0
.end method

.method static synthetic b(Lcom/android/settings/deviceinfo/Memory;)Landroid/hardware/usb/UsbManager;
    .locals 1

    .prologue
    .line 69
    iget-object v0, p0, Lcom/android/settings/deviceinfo/Memory;->hE:Landroid/hardware/usb/UsbManager;
...
.method static synthetic c(Lcom/android/settings/deviceinfo/Memory;)V
    .locals 0

    .prologue
    .line 69
    invoke-direct {p0}, Lcom/android/settings/deviceinfo/Memory;->nW()V

    return-void
.end method

.method static synthetic d(Lcom/android/settings/deviceinfo/Memory;)V
    .locals 0

    .prologue
    .line 69
    invoke-direct {p0}, Lcom/android/settings/deviceinfo/Memory;->oa()V
...
.method private declared-synchronized getMountService()Landroid/os/storage/IMountService;
    ...
    :try_start_0
    iget-object v0, p0, Lcom/android/settings/deviceinfo/Memory;->RJ:Landroid/os/storage/IMountService;
    ...
    iput-object v0, p0, Lcom/android/settings/deviceinfo/Memory;->RJ:Landroid/os/storage/IMountService;
...
.method private nV()Z
    ...
    .prologue
    .line 129
    iget-object v0, p0, Lcom/android/settings/deviceinfo/Memory;->pb:Landroid/os/storage/StorageManager;
...
.method private nW()V
    ...
    .line 345
    iget-object v0, p0, Lcom/android/settings/deviceinfo/Memory;->oh:Landroid/os/storage/StorageVolume;
    ...
    invoke-static {v0, v1}, Lcom/android/settings/MediaFormat;->a(Landroid/os/storage/StorageVolume;Landroid/content/Context;)Z
    ...
    .line 363
    sget-object v1, Lcom/android/settings/deviceinfo/Memory;->RH:Landroid/preference/Preference;
    ...
    invoke-virtual {p0, v2}, Lcom/android/settings/deviceinfo/Memory;->getString(I)Ljava/lang/String;
    ...
    invoke-direct {v1, p0, v0}, Lcom/android/settings/deviceinfo/Memory$4;-><init>(Lcom/android/settings/deviceinfo/Memory;Landroid/os/storage/IMountService;)V

    invoke-virtual {v1}, Lcom/android/settings/deviceinfo/Memory$4;->start()V
...
.method private nX()Z
    ...
    .line 395
    sget-object v1, Lcom/android/settings/deviceinfo/Memory;->RI:Ljava/lang/String;
...
.method private nY()V
    ...
    .line 416
    :try_start_0
    invoke-direct {p0}, Lcom/android/settings/deviceinfo/Memory;->nX()Z
    ...
    invoke-direct {p0, v0}, Lcom/android/settings/deviceinfo/Memory;->bj(I)V
...
.method private nZ()V
    ...
    invoke-direct {v1, p0, v0}, Lcom/android/settings/deviceinfo/Memory$5;-><init>(Lcom/android/settings/deviceinfo/Memory;Landroid/os/storage/IMountService;)V

    invoke-virtual {v1}, Lcom/android/settings/deviceinfo/Memory$5;->start()V
...
.method private oa()V
    ...
    .line 461
    invoke-virtual {v0}, Lcom/android/settings/deviceinfo/StorageVolumePreferenceCategory;->oa()V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/deviceinfo/Memory;->hE:Landroid/hardware/usb/UsbManager;
    ...
    iput-object v0, p0, Lcom/android/settings/deviceinfo/Memory;->pb:Landroid/os/storage/StorageManager;
    ...
    .line 104
    invoke-static {v2}, Lcom/android/settings/deviceinfo/StorageVolumePreferenceCategory;->aw(Landroid/content/Context;)Lcom/android/settings/deviceinfo/StorageVolumePreferenceCategory;

    move-result-object v0

    invoke-direct {p0, v0}, Lcom/android/settings/deviceinfo/Memory;->a(Lcom/android/settings/deviceinfo/StorageVolumePreferenceCategory;)V
    ...
    .line 114
    :cond_0
    invoke-static {v2, v5}, Lcom/android/settings/deviceinfo/StorageVolumePreferenceCategory;->b(Landroid/content/Context;Landroid/os/storage/StorageVolume;)Lcom/android/settings/deviceinfo/StorageVolumePreferenceCategory;

    move-result-object v5

    invoke-direct {p0, v5}, Lcom/android/settings/deviceinfo/Memory;->a(Lcom/android/settings/deviceinfo/StorageVolumePreferenceCategory;)V
...
.method public onCreateDialog(I)Landroid/app/Dialog;
    ...
    .line 303
    iget-object v3, p0, Lcom/android/settings/deviceinfo/Memory;->oh:Landroid/os/storage/StorageVolume;

    invoke-virtual {p0}, Lcom/android/settings/deviceinfo/Memory;->getActivity()Landroid/app/Activity;

    move-result-object v4

    invoke-static {v3, v4}, Lcom/android/settings/MediaFormat;->a(Landroid/os/storage/StorageVolume;Landroid/content/Context;)Z
    ...
    invoke-static {v3, v4}, Lcom/android/settings/MediaFormat;->b(Landroid/os/storage/StorageVolume;Landroid/content/Context;)Z
    ...
    .line 327
    iget-object v1, p0, Lcom/android/settings/deviceinfo/Memory;->oh:Landroid/os/storage/StorageVolume;

    invoke-virtual {p0}, Lcom/android/settings/deviceinfo/Memory;->getActivity()Landroid/app/Activity;

    move-result-object v3

    invoke-static {v1, v3}, Lcom/android/settings/MediaFormat;->a(Landroid/os/storage/StorageVolume;Landroid/content/Context;)Z
    ...
    invoke-static {v1, v3}, Lcom/android/settings/MediaFormat;->b(Landroid/os/storage/StorageVolume;Landroid/content/Context;)Z
...
.method public onPause()V
    ...
    iget-object v1, p0, Lcom/android/settings/deviceinfo/Memory;->RK:Landroid/content/BroadcastReceiver;
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    .line 234
    invoke-static {p0}, Lcom/android/settings/deviceinfo/Memory$ConfirmClearCacheFragment;->e(Lcom/android/settings/deviceinfo/Memory;)V
    ...
    .line 239
    invoke-virtual {v0, p2}, Lcom/android/settings/deviceinfo/StorageVolumePreferenceCategory;->h(Landroid/preference/Preference;)Landroid/content/Intent;
    ...
    invoke-virtual {v0, p2}, Lcom/android/settings/deviceinfo/StorageVolumePreferenceCategory;->g(Landroid/preference/Preference;)Z
    ...
    .line 258
    sput-object p2, Lcom/android/settings/deviceinfo/Memory;->RH:Landroid/preference/Preference;
    ...
    sput-object v0, Lcom/android/settings/deviceinfo/Memory;->RI:Ljava/lang/String;

    .line 260
    iput-object v3, p0, Lcom/android/settings/deviceinfo/Memory;->oh:Landroid/os/storage/StorageVolume;
    ...
    .line 265
    :cond_4
    invoke-direct {p0}, Lcom/android/settings/deviceinfo/Memory;->nY()V
    ...
    .line 267
    :cond_5
    invoke-direct {p0}, Lcom/android/settings/deviceinfo/Memory;->nZ()V
...
.method public onPrepareOptionsMenu(Landroid/view/Menu;)V
    ...
    .line 192
    invoke-direct {p0}, Lcom/android/settings/deviceinfo/Memory;->nV()Z
...
.method public onResume()V
    ...
    iget-object v2, p0, Lcom/android/settings/deviceinfo/Memory;->RK:Landroid/content/BroadcastReceiver;
