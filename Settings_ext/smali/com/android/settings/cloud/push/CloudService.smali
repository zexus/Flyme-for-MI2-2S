...
.method private a(Landroid/content/Context;Lorg/json/JSONArray;)V
    ...
    .line 72
    invoke-virtual {v5, v6}, Lcom/android/settings/cloud/push/j;->setPackageName(Ljava/lang/String;)V

    .line 73
    invoke-virtual {v5, v7}, Lcom/android/settings/cloud/push/j;->setMessage(Ljava/lang/String;)V

    .line 74
    invoke-virtual {v5, v8}, Lcom/android/settings/cloud/push/j;->setTitle(Ljava/lang/String;)V

    .line 75
    invoke-virtual {v5, v9}, Lcom/android/settings/cloud/push/j;->aF(Ljava/lang/String;)V

    .line 76
    invoke-virtual {v5, v10}, Lcom/android/settings/cloud/push/j;->aw(Z)V
    ...
    .line 84
    :cond_0
    invoke-virtual {v5, v7}, Lcom/android/settings/cloud/push/j;->a(Ljava/util/Set;)V
...
.method private b(Landroid/content/Context;Lorg/json/JSONArray;)V
    ...
    .line 110
    invoke-virtual {v5, v8}, Lcom/android/settings/cloud/push/k;->aw(Z)V
    ...
    .line 118
    :cond_0
    invoke-virtual {v5, v7}, Lcom/android/settings/cloud/push/k;->a(Ljava/util/Set;)V
    ...
    .line 124
    :cond_2
    invoke-static {p1}, Lcom/android/settings/cloud/push/e;->ao(Landroid/content/Context;)I

    .line 126
    invoke-static {p1, v3}, Lcom/android/settings/cloud/push/e;->a(Landroid/content/Context;Ljava/util/List;)V
...
.method private c(Landroid/content/Context;Ljava/util/List;)V
    ...
    .prologue
    .line 163
    invoke-static {p1}, Lcom/android/settings/cloud/push/g;->aq(Landroid/content/Context;)Lcom/android/settings/cloud/push/g;

    move-result-object v0

    invoke-virtual {v0, p2}, Lcom/android/settings/cloud/push/g;->l(Ljava/util/List;)V
...
.method private c(Landroid/content/Context;Lorg/json/JSONArray;)V
    ...
    .line 141
    invoke-virtual {v5, v8}, Lcom/android/settings/cloud/push/l;->aw(Z)V
    ...
    .line 149
    :cond_0
    invoke-virtual {v5, v7}, Lcom/android/settings/cloud/push/l;->a(Ljava/util/Set;)V
    ...
    .line 155
    :cond_2
    invoke-static {p1}, Lcom/android/settings/cloud/push/e;->ap(Landroid/content/Context;)I

    .line 157
    invoke-static {p1, v3}, Lcom/android/settings/cloud/push/e;->b(Landroid/content/Context;Ljava/util/List;)V
...
.method private d(Landroid/content/Context;Ljava/util/List;)V
    ...
    invoke-virtual {v0, p2}, Lcom/android/settings/cloud/push/g;->m(Ljava/util/List;)V
...
.method protected onHandleIntent(Landroid/content/Intent;)V
    ...
    .line 30
    invoke-direct {p0, p0, v0}, Lcom/android/settings/cloud/push/CloudService;->p(Landroid/content/Context;Ljava/lang/String;)V
