...
.field protected Qv:Lcom/android/settings/cloud/network/b;
...
.method private a(Ljava/lang/String;Ljava/lang/String;ZZLjava/io/OutputStream;)Lcom/android/settings/cloud/network/Connection$NetworkError;
    ...
    invoke-direct {p0, v0}, Lcom/android/settings/cloud/network/Connection;->be(I)Lcom/android/settings/cloud/network/Connection$NetworkError;
    ...
    .line 304
    sget-object v0, Lcom/android/settings/cloud/network/Connection$NetworkError;->QB:Lcom/android/settings/cloud/network/Connection$NetworkError;
    :try_end_7
    ...
    .line 250
    sget-object v0, Lcom/android/settings/cloud/network/Connection$NetworkError;->QA:Lcom/android/settings/cloud/network/Connection$NetworkError;
...
.method private a(Ljava/net/URL;)V
    ...
    .line 89
    iput-boolean v0, p0, Lcom/android/settings/cloud/network/Connection;->Qw:Z

    .line 90
    iput-boolean v0, p0, Lcom/android/settings/cloud/network/Connection;->Qx:Z

    .line 91
    iput-boolean v0, p0, Lcom/android/settings/cloud/network/Connection;->Qy:Z
    ...
    .line 93
    iput-object p1, p0, Lcom/android/settings/cloud/network/Connection;->Qu:Ljava/net/URL;
...
.method private be(I)Lcom/android/settings/cloud/network/Connection$NetworkError;
    .locals 3
    ...
    .line 361
    sget-object v0, Lcom/android/settings/cloud/network/Connection$NetworkError;->Qz:Lcom/android/settings/cloud/network/Connection$NetworkError;
    ...
    .line 364
    sget-object v0, Lcom/android/settings/cloud/network/Connection$NetworkError;->QF:Lcom/android/settings/cloud/network/Connection$NetworkError;
...
.method protected a(Ljava/io/OutputStream;)Lcom/android/settings/cloud/network/Connection$NetworkError;
    ...
    .prologue
    .line 187
    iget-object v0, p0, Lcom/android/settings/cloud/network/Connection;->Qu:Ljava/net/URL;
    ...
    .line 192
    :cond_0
    iget-object v0, p0, Lcom/android/settings/cloud/network/Connection;->Qv:Lcom/android/settings/cloud/network/b;
    ...
    iput-object v0, p0, Lcom/android/settings/cloud/network/Connection;->Qv:Lcom/android/settings/cloud/network/b;

    .line 196
    :cond_1
    iget-boolean v0, p0, Lcom/android/settings/cloud/network/Connection;->Qx:Z
    ...
    invoke-virtual {v0}, Lcom/android/settings/cloud/network/b;->nE()V
    ...
    .line 210
    iget-boolean v1, p0, Lcom/android/settings/cloud/network/Connection;->Qw:Z
    ...
    .line 214
    iget-object v1, p0, Lcom/android/settings/cloud/network/Connection;->Qu:Ljava/net/URL;
    ...
    .line 233
    iget-boolean v0, p0, Lcom/android/settings/cloud/network/Connection;->Qw:Z
    ...
    .line 237
    :cond_4
    iget-boolean v3, p0, Lcom/android/settings/cloud/network/Connection;->Qw:Z

    iget-boolean v4, p0, Lcom/android/settings/cloud/network/Connection;->Qy:Z
...
.method public av(Z)V
    ...
    .prologue
    .line 110
    iput-boolean p1, p0, Lcom/android/settings/cloud/network/Connection;->Qw:Z
...
.method public nC()Lorg/json/JSONObject;
    ...
    .prologue
    .line 98
    iget-object v0, p0, Lcom/android/settings/cloud/network/Connection;->Qt:Lorg/json/JSONObject;

    return-object v0
.end method

.method public nD()Lcom/android/settings/cloud/network/Connection$NetworkError;
    .locals 5
    ...
    .line 128
    :try_start_0
    sget-object v2, Lcom/android/settings/cloud/network/Connection$NetworkError;->Qz:Lcom/android/settings/cloud/network/Connection$NetworkError;
    ...
    iput-object v2, p0, Lcom/android/settings/cloud/network/Connection;->Qt:Lorg/json/JSONObject;
    :try_end_0
    ...
    .line 135
    sget-object v0, Lcom/android/settings/cloud/network/Connection$NetworkError;->QG:Lcom/android/settings/cloud/network/Connection$NetworkError;
    :try_end_3
