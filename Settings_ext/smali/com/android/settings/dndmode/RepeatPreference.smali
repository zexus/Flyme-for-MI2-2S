...
# instance fields
.field private Xf:Lcom/android/settings/dndmode/b;

.field private Xg:Lcom/android/settings/dndmode/b;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p0, Lcom/android/settings/dndmode/RepeatPreference;->Xf:Lcom/android/settings/dndmode/b;
    ...
    iput-object v0, p0, Lcom/android/settings/dndmode/RepeatPreference;->Xg:Lcom/android/settings/dndmode/b;

    .line 38
    const/4 v0, 0x0

    iput-object v0, p0, Lcom/android/settings/dndmode/RepeatPreference;->Xh:Ljava/lang/String;
...
.method static synthetic a(Lcom/android/settings/dndmode/RepeatPreference;)Lcom/android/settings/dndmode/b;
    ...
    .prologue
    .line 20
    iget-object v0, p0, Lcom/android/settings/dndmode/RepeatPreference;->Xg:Lcom/android/settings/dndmode/b;
...
.method public b(Lcom/android/settings/dndmode/b;)V
    ...
    .prologue
    .line 146
    iget-object v0, p0, Lcom/android/settings/dndmode/RepeatPreference;->Xf:Lcom/android/settings/dndmode/b;
    ...
    invoke-virtual {p1, v0, v1}, Lcom/android/settings/dndmode/b;->o(Landroid/content/Context;Z)Ljava/lang/String;
...
.method public oW()Lcom/android/settings/dndmode/b;
    .locals 1
...
.method protected onBindView(Landroid/view/View;)V
    ...
    .line 54
    iget-object v1, p0, Lcom/android/settings/dndmode/RepeatPreference;->Xh:Ljava/lang/String;
...
.method protected onClick()V
    ...
    invoke-static {v1}, Lcom/android/settings/dndmode/n;->aN(Landroid/content/Context;)Z
    ...
    :cond_0
    :goto_0
    iget-object v1, p0, Lcom/android/settings/dndmode/RepeatPreference;->Xf:Lcom/android/settings/dndmode/b;

    invoke-virtual {v1}, Lcom/android/settings/dndmode/b;->oN()I
    ...
    new-instance v3, Lcom/android/settings/dndmode/s;

    invoke-direct {v3, p0, v4}, Lcom/android/settings/dndmode/s;-><init>(Lcom/android/settings/dndmode/RepeatPreference;[I)V
...
.method protected onDialogClosed(Z)V
    ...
    iget-object v1, p0, Lcom/android/settings/dndmode/RepeatPreference;->Xg:Lcom/android/settings/dndmode/b;
...
.method protected onPrepareDialogBuilder(Landroid/app/AlertDialog$Builder;)V
    ...
    invoke-virtual {v1}, Lcom/android/settings/dndmode/b;->oP()[Z

    move-result-object v1

    new-instance v2, Lcom/android/settings/dndmode/t;

    invoke-direct {v2, p0}, Lcom/android/settings/dndmode/t;-><init>(Lcom/android/settings/dndmode/RepeatPreference;)V
...
.method public setLabel(Ljava/lang/String;)V
    ...
    .prologue
    .line 59
    iget-object v0, p0, Lcom/android/settings/dndmode/RepeatPreference;->Xh:Ljava/lang/String;
    ...
    .line 60
    iput-object p1, p0, Lcom/android/settings/dndmode/RepeatPreference;->Xh:Ljava/lang/String;
