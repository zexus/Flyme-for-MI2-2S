...
.method public constructor <init>(Landroid/app/Fragment;Landroid/widget/ImageView;Landroid/graphics/Bitmap;Landroid/graphics/drawable/Drawable;Z)V
    ...
    .line 87
    iput-object p1, p0, Lcom/android/settings/users/EditUserPhotoController;->bw:Landroid/app/Fragment;

    .line 88
    iput-object p2, p0, Lcom/android/settings/users/EditUserPhotoController;->sM:Landroid/widget/ImageView;
    ...
    :goto_0
    invoke-direct {p0, v3, v4, v0}, Lcom/android/settings/users/EditUserPhotoController;->b(Landroid/content/Context;Ljava/lang/String;Z)Landroid/net/Uri;

    move-result-object v0

    iput-object v0, p0, Lcom/android/settings/users/EditUserPhotoController;->amg:Landroid/net/Uri;
    ...
    :goto_1
    invoke-direct {p0, v0, v3, v1}, Lcom/android/settings/users/EditUserPhotoController;->b(Landroid/content/Context;Ljava/lang/String;Z)Landroid/net/Uri;

    move-result-object v0

    iput-object v0, p0, Lcom/android/settings/users/EditUserPhotoController;->amh:Landroid/net/Uri;

    .line 91
    iget-object v0, p0, Lcom/android/settings/users/EditUserPhotoController;->mContext:Landroid/content/Context;

    invoke-static {v0}, Lcom/android/settings/users/EditUserPhotoController;->bp(Landroid/content/Context;)I

    move-result v0

    iput v0, p0, Lcom/android/settings/users/EditUserPhotoController;->amf:I

    .line 92
    iget-object v0, p0, Lcom/android/settings/users/EditUserPhotoController;->sM:Landroid/widget/ImageView;
    ...
    .line 98
    iput-object p3, p0, Lcom/android/settings/users/EditUserPhotoController;->ami:Landroid/graphics/Bitmap;

    .line 99
    iput-object p4, p0, Lcom/android/settings/users/EditUserPhotoController;->amj:Landroid/graphics/drawable/Drawable;
...
.method static synthetic a(Lcom/android/settings/users/EditUserPhotoController;Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    .prologue
    .line 57
    iput-object p1, p0, Lcom/android/settings/users/EditUserPhotoController;->ami:Landroid/graphics/Bitmap;
...
.method static synthetic a(Lcom/android/settings/users/EditUserPhotoController;Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    .prologue
    .line 57
    iput-object p1, p0, Lcom/android/settings/users/EditUserPhotoController;->amj:Landroid/graphics/drawable/Drawable;
...
.method static synthetic a(Lcom/android/settings/users/EditUserPhotoController;)V
    ...
    .prologue
    .line 57
    invoke-direct {p0}, Lcom/android/settings/users/EditUserPhotoController;->sv()V
...
.method private b(Landroid/net/Uri;)V
    ...
    .line 215
    iget-object v1, p0, Lcom/android/settings/users/EditUserPhotoController;->amg:Landroid/net/Uri;

    invoke-direct {p0, v0, v1}, Lcom/android/settings/users/EditUserPhotoController;->a(Landroid/content/Intent;Landroid/net/Uri;)V

    .line 216
    invoke-direct {p0, v0}, Lcom/android/settings/users/EditUserPhotoController;->x(Landroid/content/Intent;)V
    ...
    .line 218
    iget-object v1, p0, Lcom/android/settings/users/EditUserPhotoController;->bw:Landroid/app/Fragment;
    ...
    invoke-direct {p0, p1, v0}, Lcom/android/settings/users/EditUserPhotoController;->b(Landroid/net/Uri;Z)V
...
.method static synthetic b(Lcom/android/settings/users/EditUserPhotoController;)V
    ...
    .prologue
    .line 57
    invoke-direct {p0}, Lcom/android/settings/users/EditUserPhotoController;->sz()V
...
.method static synthetic c(Lcom/android/settings/users/EditUserPhotoController;)V
    ...
    .prologue
    .line 57
    invoke-direct {p0}, Lcom/android/settings/users/EditUserPhotoController;->sy()V
...
.method static synthetic e(Lcom/android/settings/users/EditUserPhotoController;)I
    ...
    .prologue
    .line 57
    iget v0, p0, Lcom/android/settings/users/EditUserPhotoController;->amf:I
...
.method static synthetic g(Lcom/android/settings/users/EditUserPhotoController;)Landroid/graphics/Bitmap;
    ...
    .prologue
    .line 57
    iget-object v0, p0, Lcom/android/settings/users/EditUserPhotoController;->ami:Landroid/graphics/Bitmap;
...
.method static synthetic h(Lcom/android/settings/users/EditUserPhotoController;)Landroid/graphics/drawable/Drawable;
    ...
    .prologue
    .line 57
    iget-object v0, p0, Lcom/android/settings/users/EditUserPhotoController;->amj:Landroid/graphics/drawable/Drawable;
...
.method private sv()V
    ...
    .line 129
    invoke-direct {p0}, Lcom/android/settings/users/EditUserPhotoController;->sw()Z

    move-result v0

    .line 130
    invoke-direct {p0}, Lcom/android/settings/users/EditUserPhotoController;->sx()Z
    ...
    .line 140
    iget-object v3, p0, Lcom/android/settings/users/EditUserPhotoController;->sM:Landroid/widget/ImageView;
...
.method private sx()Z
    ...
    .line 194
    iget-object v2, p0, Lcom/android/settings/users/EditUserPhotoController;->sM:Landroid/widget/ImageView;
...
.method private sy()V
    ...
    .line 200
    iget-object v1, p0, Lcom/android/settings/users/EditUserPhotoController;->amh:Landroid/net/Uri;
...
.method private x(Landroid/content/Intent;)V
    ...
    iget v1, p0, Lcom/android/settings/users/EditUserPhotoController;->amf:I
...
.method public onActivityResult(IILandroid/content/Intent;)Z
    ...
    .line 114
    :pswitch_0
    invoke-direct {p0, v2}, Lcom/android/settings/users/EditUserPhotoController;->b(Landroid/net/Uri;)V
    ...
    .line 106
    :cond_1
    iget-object v2, p0, Lcom/android/settings/users/EditUserPhotoController;->amh:Landroid/net/Uri;

    goto :goto_1

    .line 110
    :pswitch_1
    invoke-direct {p0, v2, v1}, Lcom/android/settings/users/EditUserPhotoController;->b(Landroid/net/Uri;Z)V
