...
# static fields
.field public static final enum yR:Lcom/android/settings/TrustedCredentialsSettings$Tab;

.field public static final enum yS:Lcom/android/settings/TrustedCredentialsSettings$Tab;

.field private static final synthetic yT:[Lcom/android/settings/TrustedCredentialsSettings$Tab;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settings/TrustedCredentialsSettings$Tab;->yR:Lcom/android/settings/TrustedCredentialsSettings$Tab;
    ...
    sput-object v0, Lcom/android/settings/TrustedCredentialsSettings$Tab;->yS:Lcom/android/settings/TrustedCredentialsSettings$Tab;
    ...
    sget-object v2, Lcom/android/settings/TrustedCredentialsSettings$Tab;->yR:Lcom/android/settings/TrustedCredentialsSettings$Tab;

    aput-object v2, v0, v1

    const/4 v1, 0x1

    sget-object v2, Lcom/android/settings/TrustedCredentialsSettings$Tab;->yS:Lcom/android/settings/TrustedCredentialsSettings$Tab;

    aput-object v2, v0, v1

    sput-object v0, Lcom/android/settings/TrustedCredentialsSettings$Tab;->yT:[Lcom/android/settings/TrustedCredentialsSettings$Tab;
...
.method static synthetic a(Lcom/android/settings/TrustedCredentialsSettings$Tab;Lcom/android/settings/gU;)I
    .locals 1

    .prologue
    .line 71
    invoke-direct {p0, p1}, Lcom/android/settings/TrustedCredentialsSettings$Tab;->k(Lcom/android/settings/gU;)I
...
.method static synthetic a(Lcom/android/settings/TrustedCredentialsSettings$Tab;ZLcom/android/settings/gU;)V
    .locals 0

    .prologue
    .line 71
    invoke-direct {p0, p1, p2}, Lcom/android/settings/TrustedCredentialsSettings$Tab;->a(ZLcom/android/settings/gU;)V

    return-void
.end method

.method private a(ZLcom/android/settings/gU;)V
    .locals 1
    ...
    .line 151
    invoke-static {p2}, Lcom/android/settings/gU;->e(Lcom/android/settings/gU;)Lcom/android/settings/TrustedCredentialsSettings$Tab;
    ...
    .line 152
    invoke-static {p2}, Lcom/android/settings/gU;->d(Lcom/android/settings/gU;)Z
    ...
    :goto_0
    invoke-static {p2, v0}, Lcom/android/settings/gU;->a(Lcom/android/settings/gU;Z)Z

    .line 156
    :goto_1
    invoke-static {p2}, Lcom/android/settings/gU;->f(Lcom/android/settings/gU;)Lcom/android/settings/gW;
    ...
    invoke-interface {v0, p2}, Lcom/android/settings/gW;->b(Lcom/android/settings/gU;)V
    ...
    invoke-interface {v0}, Lcom/android/settings/gW;->load()V
...
.method private a(Landroid/security/IKeyChainService;Ljava/lang/String;)Z
    ...
    .line 117
    sget-object v1, Lcom/android/settings/gQ;->yK:[I
...
.method static synthetic b(Lcom/android/settings/TrustedCredentialsSettings$Tab;Lcom/android/settings/gU;)I
    .locals 1

    .prologue
    .line 71
    invoke-direct {p0, p1}, Lcom/android/settings/TrustedCredentialsSettings$Tab;->l(Lcom/android/settings/gU;)I
...
.method private k(Lcom/android/settings/gU;)I
    .locals 2
...
.method private l(Lcom/android/settings/gU;)I
    .locals 2
...
.method public static values()[Lcom/android/settings/TrustedCredentialsSettings$Tab;
    ...
    .prologue
    .line 71
    sget-object v0, Lcom/android/settings/TrustedCredentialsSettings$Tab;->yT:[Lcom/android/settings/TrustedCredentialsSettings$Tab;
