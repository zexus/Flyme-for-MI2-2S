...
.field private afZ:Lcom/android/settings/notification/VolumeSeekBarPreference$Callback;
...
.method static synthetic a(Lcom/android/settings/notification/VolumeSeekBarPreference;)Lcom/android/settings/notification/VolumeSeekBarPreference$Callback;
    ...
    .prologue
    .line 35
    iget-object v0, p0, Lcom/android/settings/notification/VolumeSeekBarPreference;->afZ:Lcom/android/settings/notification/VolumeSeekBarPreference$Callback;
...
.method static synthetic b(Lcom/android/settings/notification/VolumeSeekBarPreference;)I
    ...
    .prologue
    .line 35
    iget v0, p0, Lcom/android/settings/notification/VolumeSeekBarPreference;->afX:I
...
.method public a(Lcom/android/settings/notification/VolumeSeekBarPreference$Callback;)V
    ...
    .prologue
    .line 67
    iput-object p1, p0, Lcom/android/settings/notification/VolumeSeekBarPreference;->afZ:Lcom/android/settings/notification/VolumeSeekBarPreference$Callback;
...
.method public cb(I)V
    ...
    .prologue
    .line 63
    iput p1, p0, Lcom/android/settings/notification/VolumeSeekBarPreference;->afX:I
...
.method public cc(I)V
    ...
    .prologue
    .line 124
    iget-object v0, p0, Lcom/android/settings/notification/VolumeSeekBarPreference;->aga:Landroid/widget/ImageView;
...
.method public onActivityStop()V
    ...
    .prologue
    .line 72
    iget-object v0, p0, Lcom/android/settings/notification/VolumeSeekBarPreference;->afY:Landroid/preference/SeekBarVolumizer;
...
.method protected onBindView(Landroid/view/View;)V
    ...
    .line 86
    iget-object v1, p0, Lcom/android/settings/notification/VolumeSeekBarPreference;->tP:Landroid/widget/SeekBar;

    if-eq v0, v1, :cond_0

    .line 87
    iput-object v0, p0, Lcom/android/settings/notification/VolumeSeekBarPreference;->tP:Landroid/widget/SeekBar;
    ...
    invoke-direct {p0}, Lcom/android/settings/notification/VolumeSeekBarPreference;->qQ()Landroid/net/Uri;
    ...
    iget v3, p0, Lcom/android/settings/notification/VolumeSeekBarPreference;->afX:I
    ...
    iput-object v0, p0, Lcom/android/settings/notification/VolumeSeekBarPreference;->afY:Landroid/preference/SeekBarVolumizer;
    ...
    iput-object v0, p0, Lcom/android/settings/notification/VolumeSeekBarPreference;->aga:Landroid/widget/ImageView;

    .line 110
    iget-object v0, p0, Lcom/android/settings/notification/VolumeSeekBarPreference;->afZ:Lcom/android/settings/notification/VolumeSeekBarPreference$Callback;

    iget v1, p0, Lcom/android/settings/notification/VolumeSeekBarPreference;->afX:I

    iget-object v2, p0, Lcom/android/settings/notification/VolumeSeekBarPreference;->tP:Landroid/widget/SeekBar;

    invoke-virtual {v2}, Landroid/widget/SeekBar;->getProgress()I

    move-result v2

    invoke-interface {v0, v1, v2}, Lcom/android/settings/notification/VolumeSeekBarPreference$Callback;->k(II)V
...
.method public onProgressChanged(Landroid/widget/SeekBar;IZ)V
    ...
    invoke-interface {v0, v1, p2}, Lcom/android/settings/notification/VolumeSeekBarPreference$Callback;->k(II)V
