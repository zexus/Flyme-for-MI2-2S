...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    iget-object v0, p0, Lcom/android/settings/AllowBindAppWidgetActivity;->ag:Landroid/content/ComponentName;

    if-eqz v0, :cond_1

    iget-object v0, p0, Lcom/android/settings/AllowBindAppWidgetActivity;->ah:Ljava/lang/String;

    if-eqz v0, :cond_1

    .line 59
    :try_start_0
    iget-object v0, p0, Lcom/android/settings/AllowBindAppWidgetActivity;->ai:Landroid/appwidget/AppWidgetManager;

    iget v1, p0, Lcom/android/settings/AllowBindAppWidgetActivity;->mAppWidgetId:I

    iget-object v2, p0, Lcom/android/settings/AllowBindAppWidgetActivity;->af:Landroid/os/UserHandle;

    iget-object v3, p0, Lcom/android/settings/AllowBindAppWidgetActivity;->ag:Landroid/content/ComponentName;
    ...
    :cond_0
    :goto_0
    iget-object v0, p0, Lcom/android/settings/AllowBindAppWidgetActivity;->ae:Landroid/widget/CheckBox;
    ...
    .line 72
    iget-object v1, p0, Lcom/android/settings/AllowBindAppWidgetActivity;->ai:Landroid/appwidget/AppWidgetManager;

    iget-object v2, p0, Lcom/android/settings/AllowBindAppWidgetActivity;->ah:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/android/settings/AllowBindAppWidgetActivity;->ag:Landroid/content/ComponentName;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/AllowBindAppWidgetActivity;->af:Landroid/os/UserHandle;

    .line 98
    iget-object v0, p0, Lcom/android/settings/AllowBindAppWidgetActivity;->af:Landroid/os/UserHandle;
    ...
    iput-object v0, p0, Lcom/android/settings/AllowBindAppWidgetActivity;->ag:Landroid/content/ComponentName;
    ...
    iput-object v0, p0, Lcom/android/settings/AllowBindAppWidgetActivity;->ah:Ljava/lang/String;
    ...
    .line 105
    iget-object v1, p0, Lcom/android/settings/AllowBindAppWidgetActivity;->ah:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/android/settings/AllowBindAppWidgetActivity;->ae:Landroid/widget/CheckBox;
    ...
    iget-object v1, p0, Lcom/android/settings/AllowBindAppWidgetActivity;->ae:Landroid/widget/CheckBox;

    invoke-virtual {v1}, Landroid/widget/CheckBox;->getPaddingLeft()I

    move-result v1

    iget-object v2, p0, Lcom/android/settings/AllowBindAppWidgetActivity;->ae:Landroid/widget/CheckBox;

    invoke-virtual {v2}, Landroid/widget/CheckBox;->getPaddingTop()I

    move-result v2

    iget-object v3, p0, Lcom/android/settings/AllowBindAppWidgetActivity;->ae:Landroid/widget/CheckBox;

    invoke-virtual {v3}, Landroid/widget/CheckBox;->getPaddingRight()I

    move-result v3

    iget-object v4, p0, Lcom/android/settings/AllowBindAppWidgetActivity;->ae:Landroid/widget/CheckBox;
    ...
    iput-object v0, p0, Lcom/android/settings/AllowBindAppWidgetActivity;->ai:Landroid/appwidget/AppWidgetManager;
    ...
    iget-object v3, p0, Lcom/android/settings/AllowBindAppWidgetActivity;->af:Landroid/os/UserHandle;
    ...
    .line 109
    iput-object v6, p0, Lcom/android/settings/AllowBindAppWidgetActivity;->ag:Landroid/content/ComponentName;

    .line 110
    iput-object v6, p0, Lcom/android/settings/AllowBindAppWidgetActivity;->ah:Ljava/lang/String;
    ...
    .line 112
    invoke-virtual {p0, v5}, Lcom/android/settings/AllowBindAppWidgetActivity;->setResult(I)V
...
.method protected onPause()V
    ...
    iget-boolean v0, p0, Lcom/android/settings/AllowBindAppWidgetActivity;->aj:Z
