...
.method public static checkIfPackageIsLocked(Ljava/lang/String;)Z
    ...
    invoke-interface {v1, p0}, Lcom/miui/whetstone/IWhetstone;->checkIfPackageIsLocked(Ljava/lang/String;)Z
    :try_end_0
...
.method public static updatePackageLockedStatus(Ljava/lang/String;Z)V
    ...
    invoke-interface {v1, p0, p1}, Lcom/miui/whetstone/IWhetstone;->updatePackageLockedStatus(Ljava/lang/String;Z)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
