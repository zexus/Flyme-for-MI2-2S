...
.field private static final DEFAULT_SHOW_BLOCK_NOTIFICATION:Z = true
...
.field private static final HAS_VIEW_ANTISPAM:Ljava/lang/String; = "has_view_antispam"

.field public static final IS_BLACKLIST_NOTIFICATION:I = 0x0

.field public static final KEY_WORD_COUNT:Ljava/lang/String; = "key_word_count"
...
.method public static getHasNewBlockSMS(Landroid/content/Context;)I
    ...
    const-string v1, "has_new_block_sms"
...
.method public static getKeywordsCount(Landroid/content/Context;)I
    .locals 3
    .param p0, "context"    # Landroid/content/Context;
    ...
    const-string v1, "key_word_count"
...
.method public static getSmsActionForBlacklist(Landroid/content/Context;)I
    ...
    const-string/jumbo v1, "sms_act_of_bl"
...
.method public static hasViewAntispam(Landroid/content/Context;)Z
    .locals 3
    .param p0, "context"    # Landroid/content/Context;
    ...
    const-string v1, "has_view_antispam"
...
.method public static isCallWait(Landroid/content/Context;)Z
    .locals 3
    .param p0, "context"    # Landroid/content/Context;
    ...
    const-string v2, "call_wait_mode_enable"
...
.method public static isDisplayNote(Landroid/content/Context;)Z
    .locals 3
    .param p0, "context"    # Landroid/content/Context;
    ...
    const-string v2, "diplay_note_mode_enable"
...
.method public static isFirstEntry(Landroid/content/Context;)Z
    ...
    const-string v3, "first_enter_with_notification"
...
.method public static isMarkNumBlockSet(Landroid/content/Context;)Z
    ...
    const-string/jumbo v3, "mark_guide_is_set"
...
.method public static isQueitWristband(Landroid/content/Context;)Z
    .locals 4
    .param p0, "context"    # Landroid/content/Context;
...
.method public static isSmsFilterEnable(Landroid/content/Context;)Z
    ...
    const-string/jumbo v2, "sms_act_of_filter"
...
.method public static isUnknownSmsActionEnable(Landroid/content/Context;)Z
    ...
    const-string/jumbo v3, "sms_act_of_unknown"
...
.method public static setCallWait(Landroid/content/Context;Z)V
    .locals 3
    .param p0, "context"    # Landroid/content/Context;
    .param p1, "enable"    # Z
...
.method public static setDisplayNote(Landroid/content/Context;Z)V
    .locals 3
    .param p0, "context"    # Landroid/content/Context;
    .param p1, "enable"    # Z
...
.method public static setFirstEntry(Landroid/content/Context;I)V
    .locals 2
    .param p0, "context"    # Landroid/content/Context;
    .param p1, "count"    # I
...
.method public static setHasViewAntispam(Landroid/content/Context;Z)V
    .locals 2
    .param p0, "context"    # Landroid/content/Context;
    .param p1, "view"    # Z
...
.method public static setKeywordsCount(Landroid/content/Context;I)V
    .locals 2
    .param p0, "context"    # Landroid/content/Context;
    .param p1, "count"    # I
...
.method public static setQueitWristband(Landroid/content/Context;Z)V
    .locals 3
    .param p0, "context"    # Landroid/content/Context;
    .param p1, "enable"    # Z
...
.method public static setQuietMode(Landroid/content/Context;Z)V
    ...
    const-string/jumbo v1, "miui.intent.action.QUIET_MODE_NOTIFICATION"

    invoke-direct {v0, v1}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .line 1859
    .local v0, "intent":Landroid/content/Intent;
    const-string/jumbo v1, "miui.intent.extra.QUIET_MODE_ENABLE"
...
.method public static setUnknownSmsActionEnable(Landroid/content/Context;Z)V
    ...
    const-string/jumbo v2, "sms_act_of_unknown"
