...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-static/range {v23 .. v23}, Landroid/media/AudioService$VolumeStreamState;->access$6100(Landroid/media/AudioService$VolumeStreamState;)I
    ...
    invoke-static {v2, v3, v4}, Landroid/media/AudioService;->access$6200(Landroid/media/AudioService;IZ)V
    ...
    invoke-static {v2}, Landroid/media/AudioService;->access$6700(Landroid/media/AudioService;)Ljava/lang/Object;
    ...
    invoke-static {v2}, Landroid/media/AudioService;->access$7100(Landroid/media/AudioService;)Landroid/hardware/hdmi/HdmiControlManager;
    ...
    invoke-static {v2}, Landroid/media/AudioService;->access$7200(Landroid/media/AudioService;)Landroid/hardware/hdmi/HdmiTvClient;
    ...
    invoke-static {v4}, Landroid/media/AudioService;->access$7300(Landroid/media/AudioService;)Z
    ...
    invoke-static {v4, v2}, Landroid/media/AudioService;->access$7400(Landroid/media/AudioService;Ljava/lang/String;)V
    ...
    invoke-static {v3, v4, v5, v2}, Landroid/media/AudioService;->access$7600(Landroid/media/AudioService;IILjava/lang/String;)V
    ...
    invoke-static {v2}, Landroid/media/AudioService;->access$7700(Landroid/media/AudioService;)Landroid/os/PowerManager$WakeLock;
    ...
    invoke-static {v3, v2, v4}, Landroid/media/AudioService;->access$7800(Landroid/media/AudioService;Landroid/bluetooth/BluetoothDevice;I)V
    ...
    invoke-static {v2, v0}, Landroid/media/AudioService;->access$8000(Landroid/media/AudioService;Landroid/content/Intent;)V
    ...
    invoke-static {v3, v2}, Landroid/media/AudioService;->access$8300(Landroid/media/AudioService;Z)V
    ...
    invoke-static {v2, v3}, Landroid/media/AudioService;->access$8400(Landroid/media/AudioService;I)V
