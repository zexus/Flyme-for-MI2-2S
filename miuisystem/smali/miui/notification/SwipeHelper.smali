...
.method private createTranslationAnimation(Landroid/view/View;F)Landroid/animation/ObjectAnimator;
    ...
    .prologue
    .line 116
    iget v1, p0, Lmiui/notification/SwipeHelper;->mSwipeDirection:I
...
.method public dismissChild(Landroid/view/View;F)V
    ...
    .line 259
    iget-object v5, p0, Lmiui/notification/SwipeHelper;->mCallback:Lmiui/notification/SwipeHelper$Callback;

    invoke-interface {v5, p1}, Lmiui/notification/SwipeHelper$Callback;->getChildContentView(Landroid/view/View;)Landroid/view/View;
    ...
    invoke-interface {v5, p1}, Lmiui/notification/SwipeHelper$Callback;->canChildBeDismissed(Landroid/view/View;)Z
    ...
    invoke-direct {p0, v1}, Lmiui/notification/SwipeHelper;->getTranslation(Landroid/view/View;)F
    ...
    iget v5, p0, Lmiui/notification/SwipeHelper;->mSwipeDirection:I
    ...
    .line 267
    :cond_1
    invoke-direct {p0, v1}, Lmiui/notification/SwipeHelper;->getSize(Landroid/view/View;)F
    ...
    .local v4, "newPos":F
    :goto_0
    iget v3, p0, Lmiui/notification/SwipeHelper;->MAX_ESCAPE_ANIMATION_DURATION:I
    ...
    .line 281
    invoke-direct {p0, v1, v4}, Lmiui/notification/SwipeHelper;->createTranslationAnimation(Landroid/view/View;F)Landroid/animation/ObjectAnimator;
    ...
    invoke-direct {v5, p0, p1, v1}, Lmiui/notification/SwipeHelper$2;-><init>(Lmiui/notification/SwipeHelper;Landroid/view/View;Landroid/view/View;)V
    ...
    invoke-direct {v5, p0, v2, v1}, Lmiui/notification/SwipeHelper$3;-><init>(Lmiui/notification/SwipeHelper;ZLandroid/view/View;)V
    ...
    :cond_3
    iget v3, p0, Lmiui/notification/SwipeHelper;->DEFAULT_ESCAPE_ANIMATION_DURATION:I
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_0
    :goto_0
    iget-boolean v3, p0, Lmiui/notification/SwipeHelper;->mDragging:Z
    ...
    .line 198
    iput-boolean v3, p0, Lmiui/notification/SwipeHelper;->mLongPressSent:Z

    .line 199
    iget-object v3, p0, Lmiui/notification/SwipeHelper;->mCallback:Lmiui/notification/SwipeHelper$Callback;

    invoke-interface {v3, p1}, Lmiui/notification/SwipeHelper$Callback;->getChildAtPosition(Landroid/view/MotionEvent;)Landroid/view/View;

    move-result-object v3

    iput-object v3, p0, Lmiui/notification/SwipeHelper;->mCurrView:Landroid/view/View;

    .line 200
    iget-object v3, p0, Lmiui/notification/SwipeHelper;->mVelocityTracker:Landroid/view/VelocityTracker;
    ...
    invoke-interface {v3, v4}, Lmiui/notification/SwipeHelper$Callback;->getChildContentView(Landroid/view/View;)Landroid/view/View;

    move-result-object v3

    iput-object v3, p0, Lmiui/notification/SwipeHelper;->mCurrAnimView:Landroid/view/View;
    ...
    invoke-interface {v3, v4}, Lmiui/notification/SwipeHelper$Callback;->canChildBeDismissed(Landroid/view/View;)Z

    move-result v3

    iput-boolean v3, p0, Lmiui/notification/SwipeHelper;->mCanCurrViewBeDimissed:Z
    ...
    .line 207
    iget-object v3, p0, Lmiui/notification/SwipeHelper;->mLongPressListener:Landroid/view/View$OnLongClickListener;

    if-eqz v3, :cond_0

    .line 208
    iget-object v3, p0, Lmiui/notification/SwipeHelper;->mWatchLongPress:Ljava/lang/Runnable;

    if-nez v3, :cond_1

    .line 209
    new-instance v3, Lmiui/notification/SwipeHelper$1;

    invoke-direct {v3, p0}, Lmiui/notification/SwipeHelper$1;-><init>(Lmiui/notification/SwipeHelper;)V

    iput-object v3, p0, Lmiui/notification/SwipeHelper;->mWatchLongPress:Ljava/lang/Runnable;

    .line 220
    :cond_1
    iget-object v3, p0, Lmiui/notification/SwipeHelper;->mHandler:Landroid/os/Handler;

    iget-object v4, p0, Lmiui/notification/SwipeHelper;->mWatchLongPress:Ljava/lang/Runnable;

    iget-wide v6, p0, Lmiui/notification/SwipeHelper;->mLongPressTimeout:J
    ...
    iget-boolean v3, p0, Lmiui/notification/SwipeHelper;->mLongPressSent:Z
    ...
    .line 245
    iput-object v4, p0, Lmiui/notification/SwipeHelper;->mCurrView:Landroid/view/View;

    .line 246
    iput-object v4, p0, Lmiui/notification/SwipeHelper;->mCurrAnimView:Landroid/view/View;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-boolean v13, v0, Lmiui/notification/SwipeHelper;->mLongPressSent:Z
    ...
    iget-boolean v13, v0, Lmiui/notification/SwipeHelper;->mDragging:Z

    if-nez v13, :cond_1

    .line 326
    invoke-virtual/range {p0 .. p0}, Lmiui/notification/SwipeHelper;->removeLongPressCallback()V
    ...
    iget-object v13, v0, Lmiui/notification/SwipeHelper;->mVelocityTracker:Landroid/view/VelocityTracker;
    ...
    iget-object v13, v0, Lmiui/notification/SwipeHelper;->mCurrView:Landroid/view/View;

    if-eqz v13, :cond_2

    .line 336
    invoke-direct/range {p0 .. p1}, Lmiui/notification/SwipeHelper;->getPos(Landroid/view/MotionEvent;)F

    move-result v13

    move-object/from16 v0, p0

    iget v14, v0, Lmiui/notification/SwipeHelper;->mInitialTouchPos:F
    ...
    iget-object v13, v0, Lmiui/notification/SwipeHelper;->mCallback:Lmiui/notification/SwipeHelper$Callback;

    move-object/from16 v0, p0

    iget-object v14, v0, Lmiui/notification/SwipeHelper;->mCurrView:Landroid/view/View;

    invoke-interface {v13, v14}, Lmiui/notification/SwipeHelper$Callback;->canChildBeDismissed(Landroid/view/View;)Z
    ...
    iget-object v13, v0, Lmiui/notification/SwipeHelper;->mCurrAnimView:Landroid/view/View;

    move-object/from16 v0, p0

    invoke-direct {v0, v13}, Lmiui/notification/SwipeHelper;->getSize(Landroid/view/View;)F
    ...
    invoke-direct {v0, v13, v5}, Lmiui/notification/SwipeHelper;->setTranslation(Landroid/view/View;F)V

    .line 349
    move-object/from16 v0, p0

    iget-boolean v13, v0, Lmiui/notification/SwipeHelper;->mCanCurrViewBeDimissed:Z
    ...
    iget-object v14, v0, Lmiui/notification/SwipeHelper;->mCurrAnimView:Landroid/view/View;

    move-object/from16 v0, p0

    invoke-direct {v0, v14}, Lmiui/notification/SwipeHelper;->getAlphaForOffset(Landroid/view/View;)F
    ...
    invoke-static {v13}, Lmiui/notification/SwipeHelper;->invalidateGlobalRegion(Landroid/view/View;)V
    ...
    iget v13, v0, Lmiui/notification/SwipeHelper;->MAX_DISMISS_VELOCITY:I

    int-to-float v13, v13

    move-object/from16 v0, p0

    iget v14, v0, Lmiui/notification/SwipeHelper;->mDensityScale:F
    ...
    iget v13, v0, Lmiui/notification/SwipeHelper;->SWIPE_ESCAPE_VELOCITY:F
    ...
    invoke-direct {v0, v13}, Lmiui/notification/SwipeHelper;->getVelocity(Landroid/view/VelocityTracker;)F
    ...
    invoke-direct {v0, v13}, Lmiui/notification/SwipeHelper;->getPerpendicularVelocity(Landroid/view/VelocityTracker;)F
    ...
    invoke-direct {v0, v13}, Lmiui/notification/SwipeHelper;->getTranslation(Landroid/view/View;)F
    ...
    invoke-direct {v0, v14}, Lmiui/notification/SwipeHelper;->getTranslation(Landroid/view/View;)F
    ...
    invoke-virtual {v0, v13, v12}, Lmiui/notification/SwipeHelper;->dismissChild(Landroid/view/View;F)V
    ...
    invoke-interface {v13, v14}, Lmiui/notification/SwipeHelper$Callback;->onDragCancelled(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v13, v12}, Lmiui/notification/SwipeHelper;->snapChild(Landroid/view/View;F)V
...
.method public snapChild(Landroid/view/View;F)V
    ...
    invoke-interface {v4, p1}, Lmiui/notification/SwipeHelper$Callback;->getChildContentView(Landroid/view/View;)Landroid/view/View;
    ...
    invoke-interface {v4, v1}, Lmiui/notification/SwipeHelper$Callback;->canChildBeDismissed(Landroid/view/View;)Z
    ...
    invoke-direct {v4, p0, v2, v1}, Lmiui/notification/SwipeHelper$4;-><init>(Lmiui/notification/SwipeHelper;ZLandroid/view/View;)V
