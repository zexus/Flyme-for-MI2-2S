...
.method public static backup(Landroid/content/SharedPreferences;Lmiui/cloud/backup/data/DataPackage;[Lmiui/cloud/backup/data/PrefsBackupHelper$PrefEntry;)V
    ...
    .local v0, "arr$":[Lmiui/cloud/backup/data/PrefsBackupHelper$PrefEntry;
    array-length v3, v0
    ...
    .line 78
    .local v1, "entry":Lmiui/cloud/backup/data/PrefsBackupHelper$PrefEntry;
    invoke-virtual {v1}, Lmiui/cloud/backup/data/PrefsBackupHelper$PrefEntry;->getLocalKey()Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lmiui/cloud/backup/data/PrefsBackupHelper$PrefEntry;->getValueClass()Ljava/lang/Class;
    ...
    .line 86
    :cond_0
    invoke-virtual {v1}, Lmiui/cloud/backup/data/PrefsBackupHelper$PrefEntry;->getCloudKey()Ljava/lang/String;
    ...
    invoke-virtual {p1, v6, v7}, Lmiui/cloud/backup/data/DataPackage;->addKeyValue(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 87
    :cond_2
    invoke-virtual {v1}, Lmiui/cloud/backup/data/PrefsBackupHelper$PrefEntry;->getDefaultValue()Ljava/lang/Object;
    ...
    .line 91
    .end local v1    # "entry":Lmiui/cloud/backup/data/PrefsBackupHelper$PrefEntry;
...
.method public static restore(Landroid/content/SharedPreferences;Lmiui/cloud/backup/data/DataPackage;[Lmiui/cloud/backup/data/PrefsBackupHelper$PrefEntry;)V
    ...
    invoke-virtual {p1, v8}, Lmiui/cloud/backup/data/DataPackage;->get(Ljava/lang/String;)Lmiui/cloud/backup/data/SettingItem;

    move-result-object v5

    check-cast v5, Lmiui/cloud/backup/data/KeyStringSettingItem;

    .line 98
    .local v5, "item":Lmiui/cloud/backup/data/KeyStringSettingItem;
    if-eqz v5, :cond_4

    .line 99
    invoke-virtual {v5}, Lmiui/cloud/backup/data/KeyStringSettingItem;->getValue()Ljava/lang/Object;
    ...
    .line 95
    .end local v5    # "item":Lmiui/cloud/backup/data/KeyStringSettingItem;
    ...
    .line 102
    .restart local v5    # "item":Lmiui/cloud/backup/data/KeyStringSettingItem;
