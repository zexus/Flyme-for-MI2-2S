...
.method private broadcastDefaultDataSubIdChanged(I)V
    ...
    invoke-virtual {p0, v2, v3}, Lcom/android/internal/telephony/SubscriptionController;->getPhoneId(J)I
...
.method private getSubInfo(Ljava/lang/String;Ljava/lang/Object;)Ljava/util/List;
    ...
    .line 379
    invoke-direct {p0, v7}, Lcom/android/internal/telephony/SubscriptionController;->setDefaultDisplayName(Landroid/telephony/SubInfoRecord;)V
...
.method private setDefaultDisplayName(Landroid/telephony/SubInfoRecord;)V
    .locals 6
    .param p1, "subInfo"    # Landroid/telephony/SubInfoRecord;

    .prologue
    .line 1762
    iget-object v1, p1, Landroid/telephony/SubInfoRecord;->displayName:Ljava/lang/String;
    ...
    iget-wide v2, p1, Landroid/telephony/SubInfoRecord;->subId:J
    ...
    iget-wide v4, p1, Landroid/telephony/SubInfoRecord;->subId:J

    invoke-virtual {v2, v4, v5}, Landroid/telephony/TelephonyManager;->getNetworkOperatorName(J)Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v1, v0, v2}, Lmiui/telephony/SpnOverride;->getSpn(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v1, v2, v3}, Landroid/telephony/TelephonyManager;->getSimOperatorName(J)Ljava/lang/String;
    ...
    .line 1774
    iput-object v0, p1, Landroid/telephony/SubInfoRecord;->displayName:Ljava/lang/String;
    ...
    const-string v2, "update subInfo displayName:"

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-object v2, p1, Landroid/telephony/SubInfoRecord;->displayName:Ljava/lang/String;
    ...
    iget v2, p1, Landroid/telephony/SubInfoRecord;->slotId:I
    ...
    iget-object v2, p1, Landroid/telephony/SubInfoRecord;->number:Ljava/lang/String;
...
.method public addSubInfoRecord(Ljava/lang/String;I)I
    ...
    .line 670
    .local v10, "currentSubId":Ljava/lang/Long;
    if-eqz v10, :cond_6
    ...
    .line 699
    .end local v12    # "defaultSubId":J
    .end local v17    # "simCount":I
    :cond_9
    :goto_2
    new-instance v5, Ljava/lang/StringBuilder;
    ...
    .line 703
    .end local v10    # "currentSubId":Ljava/lang/Long;
    ...
    .line 697
    .restart local v10    # "currentSubId":Ljava/lang/Long;
    .restart local v20    # "subId":J
    .restart local v23    # "value":Landroid/content/ContentValues;
    :cond_11
    :try_start_3
