...
.method static synthetic access$1600(Lcom/android/server/ConnectivityService;Lcom/android/server/connectivity/NetworkAgentInfo;Landroid/net/LinkProperties;)V
    ...
    .prologue
    .line 189
    invoke-direct {p0, p1, p2}, Lcom/android/server/ConnectivityService;->updateLinkPropertiesExtra(Lcom/android/server/connectivity/NetworkAgentInfo;Landroid/net/LinkProperties;)V
...
.method private addInterfacesToNetwork(ILjava/util/List;)V
    .locals 5
    .param p1, "netId"    # I
    .annotation system Ldalvik/annotation/Signature;
        value = {
    ...
    .prologue
    .line 4406
    .local p2, "interfaces":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    ...
    invoke-interface {v3, v2, p1}, Landroid/os/INetworkManagementService;->addInterfaceToNetwork(Ljava/lang/String;I)V
    :try_end_0
    ...
    const-string v4, "Exception adding interface: "
...
.method private removeInterfacesFromNetwork(ILjava/util/List;)V
    .locals 5
    .param p1, "netId"    # I
    .annotation system Ldalvik/annotation/Signature;
        value = {
    ...
    invoke-interface {v3, v2, p1}, Landroid/os/INetworkManagementService;->removeInterfaceFromNetwork(Ljava/lang/String;I)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v4, "Exception removing interface: "
...
.method private updateLinkPropertiesExtra(Lcom/android/server/connectivity/NetworkAgentInfo;Landroid/net/LinkProperties;)V
    .locals 5
    .param p1, "networkAgent"    # Lcom/android/server/connectivity/NetworkAgentInfo;
    .param p2, "oldLp"    # Landroid/net/LinkProperties;
    ...
    iget v2, v4, Landroid/net/Network;->netId:I

    .line 4441
    .local v2, "netId":I
    iget-object v4, p0, Lcom/android/server/ConnectivityService;->mClat:Lcom/android/server/connectivity/Nat464Xlat;

    invoke-virtual {v4, p1, p2}, Lcom/android/server/connectivity/Nat464Xlat;->fixupLinkProperties(Lcom/android/server/connectivity/NetworkAgentInfo;Landroid/net/LinkProperties;)V
    ...
    .line 4444
    .local v1, "interfaceDiff":Landroid/net/LinkProperties$CompareResult;, "Landroid/net/LinkProperties$CompareResult<Ljava/lang/String;>;"
    if-eqz p2, :cond_3

    .line 4445
    invoke-virtual {p2, v3}, Landroid/net/LinkProperties;->compareAllInterfaceNames(Landroid/net/LinkProperties;)Landroid/net/LinkProperties$CompareResult;
    ...
    :cond_0
    :goto_0
    iget-object v4, v1, Landroid/net/LinkProperties$CompareResult;->added:Ljava/util/List;

    invoke-direct {p0, v2, v4}, Lcom/android/server/ConnectivityService;->addInterfacesToNetwork(ILjava/util/List;)V

    .line 4454
    invoke-direct {p0, v3, p2}, Lcom/android/server/ConnectivityService;->updateMtu(Landroid/net/LinkProperties;Landroid/net/LinkProperties;)V

    .line 4455
    invoke-direct {p0, p1}, Lcom/android/server/ConnectivityService;->updateTcpBufferSizes(Lcom/android/server/connectivity/NetworkAgentInfo;)V

    .line 4456
    invoke-direct {p0, v3, p2, v2}, Lcom/android/server/ConnectivityService;->updateRoutes(Landroid/net/LinkProperties;Landroid/net/LinkProperties;I)Z

    move-result v0

    .line 4457
    .local v0, "flushDns":Z
    invoke-direct {p0, v3, p2, v2, v0}, Lcom/android/server/ConnectivityService;->updateDnses(Landroid/net/LinkProperties;Landroid/net/LinkProperties;IZ)V

    .line 4458
    invoke-direct {p0, v3, p2, p1}, Lcom/android/server/ConnectivityService;->updateClat(Landroid/net/LinkProperties;Landroid/net/LinkProperties;Lcom/android/server/connectivity/NetworkAgentInfo;)V

    .line 4461
    iget-object v4, v1, Landroid/net/LinkProperties$CompareResult;->removed:Ljava/util/List;

    invoke-direct {p0, v2, v4}, Lcom/android/server/ConnectivityService;->removeInterfacesFromNetwork(ILjava/util/List;)V
    ...
    iput-object v4, v1, Landroid/net/LinkProperties$CompareResult;->added:Ljava/util/List;
...
.method private updateNetworkInfo(Lcom/android/server/connectivity/NetworkAgentInfo;Landroid/net/NetworkInfo;)V
    ...
    .line 4199
    invoke-direct {p0, p1, v7}, Lcom/android/server/ConnectivityService;->updateLinkPropertiesExtra(Lcom/android/server/connectivity/NetworkAgentInfo;Landroid/net/LinkProperties;)V
